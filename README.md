...
Download and copy into your KiCad 10 scripting plugins directory.
...
3. Open this plugin directory in your preferred agent environment (e.g., **Antigravity IDE**). 
