...
class IO_ERROR(object):
    ...
    def what(self):
        r"""what(IO_ERROR self) -> char const *"""
...
class KIID(object):
    ...
    def Combine(aFirst, aSecond):
        r"""Combine(KIID aFirst, KIID aSecond) -> KIID"""
        return _pcbnew.KIID_Combine(aFirst, aSecond)
...
PCB_BARCODE_T = _pcbnew.PCB_BARCODE_T
...
PCB_BOARD_OUTLINE_T = _pcbnew.PCB_BOARD_OUTLINE_T

PCB_POINT_T = _pcbnew.PCB_POINT_T
...
PCB_LOCATE_BLINDVIA_T = _pcbnew.PCB_LOCATE_BLINDVIA_T

PCB_LOCATE_BURIEDVIA_T = _pcbnew.PCB_LOCATE_BURIEDVIA_T
...
IGNORE_PARENT_GROUP = _pcbnew.IGNORE_PARENT_GROUP
...
class EDA_ITEM(object):
    ...
    def GetParentGroupId(self):
        r"""GetParentGroupId(EDA_ITEM self) -> KIID"""
        return _pcbnew.EDA_ITEM_GetParentGroupId(self)

    def IsLocked(self):
        r"""IsLocked(EDA_ITEM self) -> bool"""
        return _pcbnew.EDA_ITEM_IsLocked(self)

    def SetLocked(self, aLocked):
        r"""SetLocked(EDA_ITEM self, bool aLocked)"""
        return _pcbnew.EDA_ITEM_SetLocked(self, aLocked)
    ...
    def GetRolloverPos(self):
        r"""GetRolloverPos(EDA_ITEM self) -> VECTOR2I"""
        return _pcbnew.EDA_ITEM_GetRolloverPos(self)

    def SetIsRollover(self, aIsRollover, aMousePos):
        r"""SetIsRollover(EDA_ITEM self, bool aIsRollover, VECTOR2I aMousePos)"""
        return _pcbnew.EDA_ITEM_SetIsRollover(self, aIsRollover, aMousePos)
    ...
    def DisambiguateItemDescription(self, aUnitsProvider, aFull):
        r"""DisambiguateItemDescription(EDA_ITEM self, UNITS_PROVIDER aUnitsProvider, bool aFull) -> wxString"""
        return _pcbnew.EDA_ITEM_DisambiguateItemDescription(self, aUnitsProvider, aFull)
    ...
    def GetEmbeddedFonts(self):
        r"""GetEmbeddedFonts(EDA_ITEM self) -> std::vector< wxString,std::allocator< wxString > > const *"""
        return _pcbnew.EDA_ITEM_GetEmbeddedFonts(self)
    m_Uuid = property(_pcbnew.EDA_ITEM_m_Uuid_get, doc=r"""m_Uuid : q(const).KIID""")

    def PyGetClass(self):
        r"""PyGetClass(EDA_ITEM self) -> wxString"""
        return _pcbnew.EDA_ITEM_PyGetClass(self)
...
class EDA_IU_SCALE(object):
    ...
    IU_PER_PS = property(_pcbnew.EDA_IU_SCALE_IU_PER_PS_get, doc=r"""IU_PER_PS : q(const).double""")
    IU_PER_PS_PER_MM = property(_pcbnew.EDA_IU_SCALE_IU_PER_PS_PER_MM_get, doc=r"""IU_PER_PS_PER_MM : q(const).double""")
...
EDA_DATA_TYPE_TIME = _pcbnew.EDA_DATA_TYPE_TIME

EDA_DATA_TYPE_LENGTH_DELAY = _pcbnew.EDA_DATA_TYPE_LENGTH_DELAY
...
EDA_UNITS_FS = _pcbnew.EDA_UNITS_FS

EDA_UNITS_PS = _pcbnew.EDA_UNITS_PS

EDA_UNITS_PS_PER_INCH = _pcbnew.EDA_UNITS_PS_PER_INCH

EDA_UNITS_PS_PER_CM = _pcbnew.EDA_UNITS_PS_PER_CM

EDA_UNITS_PS_PER_MM = _pcbnew.EDA_UNITS_PS_PER_MM
...
def FormatInternalUnits(*args):
    r"""
    FormatInternalUnits(EDA_IU_SCALE aIuScale, int aValue, EDA_DATA_TYPE aDataType=DISTANCE) -> string
    FormatInternalUnits(EDA_IU_SCALE aIuScale, VECTOR2I aPoint) -> string
    """
    return _pcbnew.FormatInternalUnits(*args)

def GetScaleForInternalUnitType(aIuScale, aDataType):
    r"""GetScaleForInternalUnitType(EDA_IU_SCALE aIuScale, EDA_DATA_TYPE aDataType) -> double"""
    return _pcbnew.GetScaleForInternalUnitType(aIuScale, aDataType)
...
def DoubleValueFromString(*args):
    ...
    DoubleValueFromString(EDA_IU_SCALE aIuScale, wxString aTextValue, double & aDoubleValue) -> bool
    """
...
def JoinExtensions(aExts):
    r"""JoinExtensions(std::vector< std::string,std::allocator< std::string > > const & aExts) -> wxString"""
    return _pcbnew.JoinExtensions(aExts)
...
def ExpandTextVars(*args):
    r"""
    ExpandTextVars(wxString aSource, std::function< bool (wxString *) > const * aResolver, int aFlags=0, int aDepth=0) -> wxString
    ExpandTextVars(wxString aSource, PROJECT const * aProject, int aFlags=0) -> wxString
    """
    return _pcbnew.ExpandTextVars(*args)

def ResolveTextVars(aSource, aResolver, aDepth):
    r"""ResolveTextVars(wxString aSource, std::function< bool (wxString *) > const * aResolver, int & aDepth) -> wxString"""
    return _pcbnew.ResolveTextVars(aSource, aResolver, aDepth)

def GetGeneratedFieldDisplayName(aSource):
    r"""GetGeneratedFieldDisplayName(wxString aSource) -> wxString"""
    return _pcbnew.GetGeneratedFieldDisplayName(aSource)

def IsGeneratedField(aSource):
    r"""IsGeneratedField(wxString aSource) -> bool"""
    return _pcbnew.IsGeneratedField(aSource)

def DescribeRef(aRef):
    r"""DescribeRef(wxString aRef) -> wxString"""
    return _pcbnew.DescribeRef(aRef)
...
ARC_LOW_DEF_MM = cvar.ARC_LOW_DEF_MM
ARC_HIGH_DEF_MM = cvar.ARC_HIGH_DEF_MM
...
class FILE_LINE_READER(LINE_READER):
    ...
    def __init__(self, *args):
        r"""
        __init__(FILE_LINE_READER self, wxString aFileName, unsigned int aStartingLineNumber=0, unsigned int aMaxLineLength=16000000) -> FILE_LINE_READER
        __init__(FILE_LINE_READER self, FILE * aFile, wxString aFileName, bool doOwn=True, unsigned int aStartingLineNumber=0, unsigned int aMaxLineLength=16000000) -> FILE_LINE_READER
        """
...
class STRING_FORMATTER(OUTPUTFORMATTER):
    ...
    def MutableString(self):
        r"""MutableString(STRING_FORMATTER self) -> string"""
        return _pcbnew.STRING_FORMATTER_MutableString(self)
...
class PRETTIFIED_FILE_OUTPUTFORMATTER(OUTPUTFORMATTER):
    ...
    def __init__(self, *args):
        r"""__init__(PRETTIFIED_FILE_OUTPUTFORMATTER self, wxString aFileName, KICAD_FORMAT::FORMAT_MODE aFormatMode=KICAD_FORMAT::FORMAT_MODE::NORMAL, wxChar const * aMode=wxT( "wt" ), char aQuoteChar='\"') -> PRETTIFIED_FILE_OUTPUTFORMATTER"""
...
class TITLE_BLOCK(object):
    ...
    @staticmethod
    def GetCurrentTimeHHMMSS():
        r"""GetCurrentTimeHHMMSS() -> wxString"""
        return _pcbnew.TITLE_BLOCK_GetCurrentTimeHHMMSS()

    @staticmethod
    def GetCurrentTimeLocale():
        r"""GetCurrentTimeLocale() -> wxString"""
        return _pcbnew.TITLE_BLOCK_GetCurrentTimeLocale()
...
class COLOR4D(object):
    ...
    m_text = property(_pcbnew.COLOR4D_m_text_get, _pcbnew.COLOR4D_m_text_set, doc=r"""m_text : std::shared_ptr<(wxString)>""")
...
class EDA_TEXT(object):
    ...
    def EvaluateText(self, aText):
        r"""EvaluateText(EDA_TEXT self, wxString aText) -> wxString"""
        return _pcbnew.EDA_TEXT_EvaluateText(self, aText)
    ...
    def GetTextThicknessProperty(self):
        r"""GetTextThicknessProperty(EDA_TEXT self) -> int"""
        return _pcbnew.EDA_TEXT_GetTextThicknessProperty(self)

    def SetAutoThickness(self, aAuto):
        r"""SetAutoThickness(EDA_TEXT self, bool aAuto)"""
        return _pcbnew.EDA_TEXT_SetAutoThickness(self, aAuto)

    def GetAutoThickness(self):
        r"""GetAutoThickness(EDA_TEXT self) -> bool"""
        return _pcbnew.EDA_TEXT_GetAutoThickness(self)
    ...
    def SetFontProp(self, aFontName):
        r"""SetFontProp(EDA_TEXT self, wxString aFontName)"""
        return _pcbnew.EDA_TEXT_SetFontProp(self, aFontName)

    def GetFontProp(self):
        r"""GetFontProp(EDA_TEXT self) -> wxString"""
        return _pcbnew.EDA_TEXT_GetFontProp(self)
    ...
    def SetActiveUrl(self, aUrl):
        r"""SetActiveUrl(EDA_TEXT self, wxString aUrl)"""
        return _pcbnew.EDA_TEXT_SetActiveUrl(self, aUrl)
    ...
    def Print(self, aSettings, aOffset, aColor):
        r"""Print(EDA_TEXT self, RENDER_SETTINGS const * aSettings, VECTOR2I aOffset, COLOR4D aColor)"""
        return _pcbnew.EDA_TEXT_Print(self, aSettings, aOffset, aColor)
    ...
    def GetTextBox(self, aSettings, aLine=-1):
        r"""GetTextBox(EDA_TEXT self, RENDER_SETTINGS const * aSettings, int aLine=-1) -> BOX2I"""
        return _pcbnew.EDA_TEXT_GetTextBox(self, aSettings, aLine)

    def GetInterline(self, aSettings):
        r"""GetInterline(EDA_TEXT self, RENDER_SETTINGS const * aSettings) -> int"""
        return _pcbnew.EDA_TEXT_GetInterline(self, aSettings)
    ...
    def GetLinePositions(self, aSettings, aPositions, aLineCount):
        r"""GetLinePositions(EDA_TEXT self, RENDER_SETTINGS const * aSettings, VECTOR_VECTOR2I aPositions, int aLineCount)"""
        return _pcbnew.EDA_TEXT_GetLinePositions(self, aSettings, aPositions, aLineCount)
    ...
    def GetDrawFont(self, aSettings):
        r"""GetDrawFont(EDA_TEXT self, RENDER_SETTINGS const * aSettings) -> KIFONT::FONT *"""
        return _pcbnew.EDA_TEXT_GetDrawFont(self, aSettings)
...
def SetOpenGLBackendInfo(aBackend):
    r"""SetOpenGLBackendInfo(wxString aBackend)"""
    return _pcbnew.SetOpenGLBackendInfo(aBackend)
...
LAYER_VIA_BLIND = _pcbnew.LAYER_VIA_BLIND

LAYER_VIA_BURIED = _pcbnew.LAYER_VIA_BURIED
...
LAYER_FILLED_SHAPES = _pcbnew.LAYER_FILLED_SHAPES

LAYER_DRC_SHAPES = _pcbnew.LAYER_DRC_SHAPES

LAYER_BOARD_OUTLINE_AREA = _pcbnew.LAYER_BOARD_OUTLINE_AREA

LAYER_POINTS = _pcbnew.LAYER_POINTS
...
LAYER_POINT_START = _pcbnew.LAYER_POINT_START

LAYER_POINT_END = _pcbnew.LAYER_POINT_END
...
LAYER_DRAG_NET_COLLISION = _pcbnew.LAYER_DRAG_NET_COLLISION
...
LAYER_GROUP = _pcbnew.LAYER_GROUP
...
def IsPointsLayer(aLayer):
    r"""IsPointsLayer(int aLayer) -> bool"""
    return _pcbnew.IsPointsLayer(aLayer)
...
class SETTINGS_MANAGER(object):
    ...
    def __init__(self):
        r"""__init__(SETTINGS_MANAGER self) -> SETTINGS_MANAGER"""
        _pcbnew.SETTINGS_MANAGER_swiginit(self, _pcbnew.new_SETTINGS_MANAGER())
    __swig_destroy__ = _pcbnew.delete_SETTINGS_MANAGER

    def SettingsDirectoryValid(self):
        r"""SettingsDirectoryValid(SETTINGS_MANAGER self) -> bool"""
        return _pcbnew.SETTINGS_MANAGER_SettingsDirectoryValid(self)
    ...
    def ResetToDefaults(self):
        r"""ResetToDefaults(SETTINGS_MANAGER self)"""
        return _pcbnew.SETTINGS_MANAGER_ResetToDefaults(self)

    def ClearFileHistory(self):
        r"""ClearFileHistory(SETTINGS_MANAGER self)"""
        return _pcbnew.SETTINGS_MANAGER_ClearFileHistory(self)

    def GetColorSettings(self, aName):
        r"""GetColorSettings(SETTINGS_MANAGER self, wxString aName) -> COLOR_SETTINGS *"""
        return _pcbnew.SETTINGS_MANAGER_GetColorSettings(self, aName)
    ...
    def MigrateFromPreviousVersion(self, aSourcePath):
        r"""MigrateFromPreviousVersion(SETTINGS_MANAGER self, wxString aSourcePath) -> bool"""
        return _pcbnew.SETTINGS_MANAGER_MigrateFromPreviousVersion(self, aSourcePath)
    ...
    def GetProjectForPath(self, aProjectPath):
        r"""GetProjectForPath(SETTINGS_MANAGER self, wxString aProjectPath) -> PROJECT *"""
        return _pcbnew.SETTINGS_MANAGER_GetProjectForPath(self, aProjectPath)
    ...
    def GetBackupRootForProject(self, aProject=None):
        r"""GetBackupRootForProject(SETTINGS_MANAGER self, PROJECT const * aProject=None) -> wxString"""
        return _pcbnew.SETTINGS_MANAGER_GetBackupRootForProject(self, aProject)

    def GetLocalHistoryDirForProject(self, aProject=None):
        r"""GetLocalHistoryDirForProject(SETTINGS_MANAGER self, PROJECT const * aProject=None) -> wxString"""
        return _pcbnew.SETTINGS_MANAGER_GetLocalHistoryDirForProject(self, aProject)

    def GetLocalHistoryDirForPath(self, aProjectPath):
        r"""GetLocalHistoryDirForPath(SETTINGS_MANAGER self, wxString aProjectPath) -> wxString"""
        return _pcbnew.SETTINGS_MANAGER_GetLocalHistoryDirForPath(self, aProjectPath)

    def GetAutosaveRootForProject(self, aProject=None):
        r"""GetAutosaveRootForProject(SETTINGS_MANAGER self, PROJECT const * aProject=None) -> wxString"""
        return _pcbnew.SETTINGS_MANAGER_GetAutosaveRootForProject(self, aProject)
...
def GetColorSettings(aName):
    r"""GetColorSettings(wxString aName) -> COLOR_SETTINGS *"""
    return _pcbnew.GetColorSettings(aName)
...
def KiROUND(*args):
    ...
    KiROUND(double x, double y) -> VECTOR2I
...
class SEG(object):
    ...
    def IntersectsLine(self, aSlope, aOffset, aIntersection):
        r"""IntersectsLine(SEG self, double aSlope, double aOffset, VECTOR2I aIntersection) -> bool"""
        return _pcbnew.SEG_IntersectsLine(self, aSlope, aOffset, aIntersection)
...
class SHAPE(SHAPE_BASE):
    ...
    def NearestPoints(self, aOther, aPtThis, aPtOther):
        r"""NearestPoints(SHAPE self, SHAPE aOther, VECTOR2I aPtThis, VECTOR2I aPtOther) -> bool"""
        return _pcbnew.SHAPE_NearestPoints(self, aOther, aPtThis, aPtOther)
    ...
    def GetStart(self):
        r"""GetStart(SHAPE self) -> VECTOR2I"""
        return _pcbnew.SHAPE_GetStart(self)

    def GetEnd(self):
        r"""GetEnd(SHAPE self) -> VECTOR2I"""
        return _pcbnew.SHAPE_GetEnd(self)

    def GetWidth(self):
        r"""GetWidth(SHAPE self) -> int"""
        return _pcbnew.SHAPE_GetWidth(self)

    def SetWidth(self, aWidth):
        r"""SetWidth(SHAPE self, int aWidth)"""
        return _pcbnew.SHAPE_SetWidth(self, aWidth)
...
class SHAPE_ARC(SHAPE):
    ...
    def DefaultAccuracyForPCB():
        r"""DefaultAccuracyForPCB() -> int"""
        return _pcbnew.SHAPE_ARC_DefaultAccuracyForPCB()

    def ConvertToPolyline(self, *args):
        r"""ConvertToPolyline(SHAPE_ARC self, int aMaxError=SHAPE_ARC::DefaultAccuracyForPCB(), int * aActualError=None) -> SHAPE_LINE_CHAIN"""
...
class SHAPE_LINE_CHAIN(SHAPE_LINE_CHAIN_BASE):
    ...
    def Simplify(self, aTolerance=0):
        r"""Simplify(SHAPE_LINE_CHAIN self, int aTolerance=0)"""
        return _pcbnew.SHAPE_LINE_CHAIN_Simplify(self, aTolerance)
    ...
    def Slice(self, *args):
        ...
        """
        return _pcbnew.SHAPE_LINE_CHAIN_Slice(self, *args)
    ...
    def Intersects(self, *args):
        ...
        """
        return _pcbnew.SHAPE_LINE_CHAIN_Intersects(self, *args)
    ...
    def CompareGeometry(self, aOther, aCyclicalCompare=False, aEpsilon=0):
        r"""CompareGeometry(SHAPE_LINE_CHAIN self, SHAPE_LINE_CHAIN aOther, bool aCyclicalCompare=False, int aEpsilon=0) -> bool"""
        return _pcbnew.SHAPE_LINE_CHAIN_CompareGeometry(self, aOther, aCyclicalCompare, aEpsilon)
...
class SHAPE_POLY_SET(SHAPE):
    ...
    def Fracture(self, aSimplify=True):
        r"""Fracture(SHAPE_POLY_SET self, bool aSimplify=True)"""
        return _pcbnew.SHAPE_POLY_SET_Fracture(self, aSimplify)
    ...
    def Scale(self, aScaleFactorX, aScaleFactorY, aCenter):
        r"""Scale(SHAPE_POLY_SET self, double aScaleFactorX, double aScaleFactorY, VECTOR2I aCenter)"""
        return _pcbnew.SHAPE_POLY_SET_Scale(self, aScaleFactorX, aScaleFactorY, aCenter)
...
class SHAPE_RECT(SHAPE):
    ...
    def GetRadius(self):
        r"""GetRadius(SHAPE_RECT self) -> int"""
        return _pcbnew.SHAPE_RECT_GetRadius(self)

    def SetRadius(self, aRadius):
        r"""SetRadius(SHAPE_RECT self, int aRadius)"""
        return _pcbnew.SHAPE_RECT_SetRadius(self, aRadius)
    ...
    def Normalize(self):
        r"""Normalize(SHAPE_RECT self)"""
        return _pcbnew.SHAPE_RECT_Normalize(self)
...
class SHAPE_SEGMENT(SHAPE):
    ...
    @staticmethod
    def BySizeAndCenter(aSize, aCenter, aRotation):
        r"""BySizeAndCenter(VECTOR2I aSize, VECTOR2I aCenter, EDA_ANGLE aRotation) -> SHAPE_SEGMENT"""
        return _pcbnew.SHAPE_SEGMENT_BySizeAndCenter(aSize, aCenter, aRotation)
    ...
    def GetTotalLength(self):
        r"""GetTotalLength(SHAPE_SEGMENT self) -> int"""
        return _pcbnew.SHAPE_SEGMENT_GetTotalLength(self)

    def GetCenter(self):
        r"""GetCenter(SHAPE_SEGMENT self) -> VECTOR2I"""
        return _pcbnew.SHAPE_SEGMENT_GetCenter(self)

    def GetAngle(self):
        r"""GetAngle(SHAPE_SEGMENT self) -> EDA_ANGLE"""
        return _pcbnew.SHAPE_SEGMENT_GetAngle(self)
...
class PCB_IO_MGR(object):
    ...
    ALLEGRO = _pcbnew.PCB_IO_MGR_ALLEGRO
    ...
    PADS = _pcbnew.PCB_IO_MGR_PADS
    
    FILE_TYPE_NONE = _pcbnew.PCB_IO_MGR_FILE_TYPE_NONE
    
    NESTED_TABLE = _pcbnew.PCB_IO_MGR_NESTED_TABLE
    

    @staticmethod
    def FindPlugin(aFileType):
        r"""FindPlugin(PCB_IO_MGR::PCB_FILE_T aFileType) -> PCB_IO"""
        return _pcbnew.PCB_IO_MGR_FindPlugin(aFileType)
...
class PCB_IO(object):
    ...
    def IsPCB_IO(self):
        r"""IsPCB_IO(PCB_IO self) -> bool"""
        return _pcbnew.PCB_IO_IsPCB_IO(self)
    ...
    def CachesEnumeratedFootprints(self):
        r"""CachesEnumeratedFootprints(PCB_IO self) -> bool"""
        return _pcbnew.PCB_IO_CachesEnumeratedFootprints(self)
    ...
    def ClearCachedFootprints(self, aLibraryPath):
        r"""ClearCachedFootprints(PCB_IO self, wxString aLibraryPath)"""
        return _pcbnew.PCB_IO_ClearCachedFootprints(self, aLibraryPath)
...
APPEND_PRESERVE_DESTINATION_STACKUP = cvar.APPEND_PRESERVE_DESTINATION_STACKUP
...
class PCB_IO_KICAD_SEXPR(PCB_IO):
    ...
    def FormatBoardToFormatter(self, aOut, aBoard, aProperties=None):
        r"""FormatBoardToFormatter(PCB_IO_KICAD_SEXPR self, OUTPUTFORMATTER aOut, BOARD aBoard, str_utf8_Map aProperties=None)"""
        return _pcbnew.PCB_IO_KICAD_SEXPR_FormatBoardToFormatter(self, aOut, aBoard, aProperties)
...
class PCB_PLOT_PARAMS(object):
    ...
    def SetDXFPlotMode(self, aPlotMode):
        r"""SetDXFPlotMode(PCB_PLOT_PARAMS self, DXF_OUTLINE_MODE aPlotMode)"""
        return _pcbnew.PCB_PLOT_PARAMS_SetDXFPlotMode(self, aPlotMode)

    def GetDXFPlotMode(self):
        r"""GetDXFPlotMode(PCB_PLOT_PARAMS self) -> DXF_OUTLINE_MODE"""
        return _pcbnew.PCB_PLOT_PARAMS_GetDXFPlotMode(self)
    ...
    def GetBlackAndWhite(self):
        r"""GetBlackAndWhite(PCB_PLOT_PARAMS self) -> bool"""
    ...
    def SetDXFMultiLayeredExportOption(self, aFlag):
        r"""SetDXFMultiLayeredExportOption(PCB_PLOT_PARAMS self, bool aFlag)"""
        return _pcbnew.PCB_PLOT_PARAMS_SetDXFMultiLayeredExportOption(self, aFlag)

    def GetDXFMultiLayeredExportOption(self):
        r"""GetDXFMultiLayeredExportOption(PCB_PLOT_PARAMS self) -> bool"""
        return _pcbnew.PCB_PLOT_PARAMS_GetDXFMultiLayeredExportOption(self)

    def SetLayersToExport(self, aVal):
        r"""SetLayersToExport(PCB_PLOT_PARAMS self, std::vector< std::pair< PCB_LAYER_ID,wxString >,std::allocator< std::pair< PCB_LAYER_ID,wxString > > > & aVal)"""
        return _pcbnew.PCB_PLOT_PARAMS_SetLayersToExport(self, aVal)

    def GetLayersToExport(self):
        r"""GetLayersToExport(PCB_PLOT_PARAMS self) -> std::vector< std::pair< PCB_LAYER_ID,wxString >,std::allocator< std::pair< PCB_LAYER_ID,wxString > > >"""
        return _pcbnew.PCB_PLOT_PARAMS_GetLayersToExport(self)

    def GetLayer(self):
        r"""GetLayer(PCB_PLOT_PARAMS self) -> PCB_LAYER_ID"""
        return _pcbnew.PCB_PLOT_PARAMS_GetLayer(self)

    def SetLayer(self, aLayer):
        r"""SetLayer(PCB_PLOT_PARAMS self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PCB_PLOT_PARAMS_SetLayer(self, aLayer)

    def SetPDFBackgroundColor(self, aColor):
        r"""SetPDFBackgroundColor(PCB_PLOT_PARAMS self, COLOR4D aColor)"""
        return _pcbnew.PCB_PLOT_PARAMS_SetPDFBackgroundColor(self, aColor)

    def GetPDFBackgroundColor(self):
        r"""GetPDFBackgroundColor(PCB_PLOT_PARAMS self) -> COLOR4D"""
        return _pcbnew.PCB_PLOT_PARAMS_GetPDFBackgroundColor(self)
    ...
    m_PDFBackgroundColor = property(_pcbnew.PCB_PLOT_PARAMS_m_PDFBackgroundColor_get, _pcbnew.PCB_PLOT_PARAMS_m_PDFBackgroundColor_set, doc=r"""m_PDFBackgroundColor : COLOR4D""")
...
class PLOT_PARAMS(object):
    r"""Proxy of C++ PLOT_PARAMS class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def GetDXFPlotMode(self):
        r"""GetDXFPlotMode(PLOT_PARAMS self) -> DXF_OUTLINE_MODE"""
        return _pcbnew.PLOT_PARAMS_GetDXFPlotMode(self)

    def GetTextMode(self):
        r"""GetTextMode(PLOT_PARAMS self) -> PLOT_TEXT_MODE"""
        return _pcbnew.PLOT_PARAMS_GetTextMode(self)

    def __init__(self):
        r"""__init__(PLOT_PARAMS self) -> PLOT_PARAMS"""
        _pcbnew.PLOT_PARAMS_swiginit(self, _pcbnew.new_PLOT_PARAMS())
    __swig_destroy__ = _pcbnew.delete_PLOT_PARAMS

# Register PLOT_PARAMS in _pcbnew:
_pcbnew.PLOT_PARAMS_swigregister(PLOT_PARAMS)
DXF_LAYER_OUTPUT_MODE_Layer_Name = _pcbnew.DXF_LAYER_OUTPUT_MODE_Layer_Name

DXF_LAYER_OUTPUT_MODE_Layer_Color_Name = _pcbnew.DXF_LAYER_OUTPUT_MODE_Layer_Color_Name

DXF_LAYER_OUTPUT_MODE_Current_Layer_Name = _pcbnew.DXF_LAYER_OUTPUT_MODE_Current_Layer_Name

DXF_LAYER_OUTPUT_MODE_Current_Layer_Color_Name = _pcbnew.DXF_LAYER_OUTPUT_MODE_Current_Layer_Color_Name
...
class PLOTTER(object):
    ...
    def SetLayersToExport(self, aLayersToExport):
        r"""SetLayersToExport(PLOTTER self, std::vector< std::pair< PCB_LAYER_ID,wxString >,std::allocator< std::pair< PCB_LAYER_ID,wxString > > > const & aLayersToExport)"""
        return _pcbnew.PLOTTER_SetLayersToExport(self, aLayersToExport)

    def GetLayer(self):
        r"""GetLayer(PLOTTER self) -> PCB_LAYER_ID"""
        return _pcbnew.PLOTTER_GetLayer(self)

    def SetLayer(self, aLayer):
        r"""SetLayer(PLOTTER self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PLOTTER_SetLayer(self, aLayer)
    ...
    def Rect(self, p1, p2, fill, width, aCornerRadius=0):
        r"""Rect(PLOTTER self, VECTOR2I p1, VECTOR2I p2, FILL_T fill, int width, int aCornerRadius=0)"""
        return _pcbnew.PLOTTER_Rect(self, p1, p2, fill, width, aCornerRadius)

    def Circle(self, pos, diametre, fill, width):
        r"""Circle(PLOTTER self, VECTOR2I pos, int diametre, FILL_T fill, int width)"""
        return _pcbnew.PLOTTER_Circle(self, pos, diametre, fill, width)
    ...
    def BezierCurve(self, aStart, aControl1, aControl2, aEnd, aTolerance, aLineThickness):
        r"""BezierCurve(PLOTTER self, VECTOR2I aStart, VECTOR2I aControl1, VECTOR2I aControl2, VECTOR2I aEnd, int aTolerance, int aLineThickness)"""
        return _pcbnew.PLOTTER_BezierCurve(self, aStart, aControl1, aControl2, aEnd, aTolerance, aLineThickness)
    ...
    def ThickSegment(self, start, end, width, aData):
        r"""ThickSegment(PLOTTER self, VECTOR2I start, VECTOR2I end, int width, void * aData)"""
        return _pcbnew.PLOTTER_ThickSegment(self, start, end, width, aData)
    ...
    def ThickRect(self, p1, p2, width, aData):
        r"""ThickRect(PLOTTER self, VECTOR2I p1, VECTOR2I p2, int width, void * aData)"""
        return _pcbnew.PLOTTER_ThickRect(self, p1, p2, width, aData)

    def ThickCircle(self, pos, diametre, width, aData):
        r"""ThickCircle(PLOTTER self, VECTOR2I pos, int diametre, int width, void * aData)"""
        return _pcbnew.PLOTTER_ThickCircle(self, pos, diametre, width, aData)

    def FilledCircle(self, pos, diametre, aData):
        r"""FilledCircle(PLOTTER self, VECTOR2I pos, int diametre, void * aData)"""
        return _pcbnew.PLOTTER_FilledCircle(self, pos, diametre, aData)

    def ThickOval(self, aPos, aSize, aOrient, aWidth, aData):
        r"""ThickOval(PLOTTER self, VECTOR2I aPos, VECTOR2I aSize, EDA_ANGLE aOrient, int aWidth, void * aData)"""
        return _pcbnew.PLOTTER_ThickOval(self, aPos, aSize, aOrient, aWidth, aData)

    def ThickPoly(self, aPoly, aWidth, aData):
        r"""ThickPoly(PLOTTER self, SHAPE_POLY_SET aPoly, int aWidth, void * aData)"""
        return _pcbnew.PLOTTER_ThickPoly(self, aPoly, aWidth, aData)

    def FlashPadCircle(self, aPadPos, aDiameter, aData):
        r"""FlashPadCircle(PLOTTER self, VECTOR2I aPadPos, int aDiameter, void * aData)"""
        return _pcbnew.PLOTTER_FlashPadCircle(self, aPadPos, aDiameter, aData)

    def FlashPadOval(self, aPadPos, aSize, aPadOrient, aData):
        r"""FlashPadOval(PLOTTER self, VECTOR2I aPadPos, VECTOR2I aSize, EDA_ANGLE aPadOrient, void * aData)"""
        return _pcbnew.PLOTTER_FlashPadOval(self, aPadPos, aSize, aPadOrient, aData)

    def FlashPadRect(self, aPadPos, aSize, aPadOrient, aData):
        r"""FlashPadRect(PLOTTER self, VECTOR2I aPadPos, VECTOR2I aSize, EDA_ANGLE aPadOrient, void * aData)"""
        return _pcbnew.PLOTTER_FlashPadRect(self, aPadPos, aSize, aPadOrient, aData)

    def FlashPadRoundRect(self, aPadPos, aSize, aCornerRadius, aOrient, aData):
        r"""FlashPadRoundRect(PLOTTER self, VECTOR2I aPadPos, VECTOR2I aSize, int aCornerRadius, EDA_ANGLE aOrient, void * aData)"""
        return _pcbnew.PLOTTER_FlashPadRoundRect(self, aPadPos, aSize, aCornerRadius, aOrient, aData)

    def FlashPadCustom(self, aPadPos, aSize, aPadOrient, aPolygons, aData):
        r"""FlashPadCustom(PLOTTER self, VECTOR2I aPadPos, VECTOR2I aSize, EDA_ANGLE aPadOrient, SHAPE_POLY_SET aPolygons, void * aData)"""
        return _pcbnew.PLOTTER_FlashPadCustom(self, aPadPos, aSize, aPadOrient, aPolygons, aData)

    def FlashPadTrapez(self, aPadPos, aCorners, aPadOrient, aData):
        r"""FlashPadTrapez(PLOTTER self, VECTOR2I aPadPos, VECTOR2I aCorners, EDA_ANGLE aPadOrient, void * aData)"""
        return _pcbnew.PLOTTER_FlashPadTrapez(self, aPadPos, aCorners, aPadOrient, aData)

    def FlashRegularPolygon(self, aShapePos, aDiameter, aCornerCount, aOrient, aData):
        r"""FlashRegularPolygon(PLOTTER self, VECTOR2I aShapePos, int aDiameter, int aCornerCount, EDA_ANGLE aOrient, void * aData)"""
        return _pcbnew.PLOTTER_FlashRegularPolygon(self, aShapePos, aDiameter, aCornerCount, aOrient, aData)
...
class IPC356D_WRITER(object):
    ...
    def SetDoNotExportUnconnectedPads(self, aDoNotExportUnconnectedPads):
        r"""SetDoNotExportUnconnectedPads(IPC356D_WRITER self, bool aDoNotExportUnconnectedPads)"""
        return _pcbnew.IPC356D_WRITER_SetDoNotExportUnconnectedPads(self, aDoNotExportUnconnectedPads)
...
class PLACE_FILE_EXPORTER(object):
    ...
    def __init__(self, aBoard, aUnitsMM, aOnlySMD, aExcludeAllTH, aExcludeDNP, aExcludeBOM, aTopSide, aBottomSide, aFormatCSV, aUseAuxOrigin, aNegateBottomX):
        r"""__init__(PLACE_FILE_EXPORTER self, BOARD aBoard, bool aUnitsMM, bool aOnlySMD, bool aExcludeAllTH, bool aExcludeDNP, bool aExcludeBOM, bool aTopSide, bool aBottomSide, bool aFormatCSV, bool aUseAuxOrigin, bool aNegateBottomX) -> PLACE_FILE_EXPORTER"""
        _pcbnew.PLACE_FILE_EXPORTER_swiginit(self, _pcbnew.new_PLACE_FILE_EXPORTER(aBoard, aUnitsMM, aOnlySMD, aExcludeAllTH, aExcludeDNP, aExcludeBOM, aTopSide, aBottomSide, aFormatCSV, aUseAuxOrigin, aNegateBottomX))
    ...
    def SetVariant(self, aVariant):
        r"""SetVariant(PLACE_FILE_EXPORTER self, wxString aVariant)"""
        return _pcbnew.PLACE_FILE_EXPORTER_SetVariant(self, aVariant)
...
HOLE_ATTRIBUTE_HOLE_VIA_BACKDRILL = _pcbnew.HOLE_ATTRIBUTE_HOLE_VIA_BACKDRILL

HOLE_ATTRIBUTE_HOLE_PAD = _pcbnew.HOLE_ATTRIBUTE_HOLE_PAD

HOLE_ATTRIBUTE_HOLE_PAD_CASTELLATED = _pcbnew.HOLE_ATTRIBUTE_HOLE_PAD_CASTELLATED

HOLE_ATTRIBUTE_HOLE_PAD_PRESSFIT = _pcbnew.HOLE_ATTRIBUTE_HOLE_PAD_PRESSFIT
...
class DRILL_TOOL(object):
    ...
    m_IsBackdrill = property(_pcbnew.DRILL_TOOL_m_IsBackdrill_get, _pcbnew.DRILL_TOOL_m_IsBackdrill_set, doc=r"""m_IsBackdrill : bool""")
    m_HasPostMachining = property(_pcbnew.DRILL_TOOL_m_HasPostMachining_get, _pcbnew.DRILL_TOOL_m_HasPostMachining_set, doc=r"""m_HasPostMachining : bool""")
    m_MinStubLength = property(_pcbnew.DRILL_TOOL_m_MinStubLength_get, _pcbnew.DRILL_TOOL_m_MinStubLength_set, doc=r"""m_MinStubLength : std::optional<(int)>""")
    m_MaxStubLength = property(_pcbnew.DRILL_TOOL_m_MaxStubLength_get, _pcbnew.DRILL_TOOL_m_MaxStubLength_set, doc=r"""m_MaxStubLength : std::optional<(int)>""")
...
class HOLE_INFO(object):
    ...
    m_IsBackdrill = property(_pcbnew.HOLE_INFO_m_IsBackdrill_get, _pcbnew.HOLE_INFO_m_IsBackdrill_set, doc=r"""m_IsBackdrill : bool""")
    m_FrontPostMachining = property(_pcbnew.HOLE_INFO_m_FrontPostMachining_get, _pcbnew.HOLE_INFO_m_FrontPostMachining_set, doc=r"""m_FrontPostMachining : PAD_DRILL_POST_MACHINING_MODE""")
    m_FrontPostMachiningSize = property(_pcbnew.HOLE_INFO_m_FrontPostMachiningSize_get, _pcbnew.HOLE_INFO_m_FrontPostMachiningSize_set, doc=r"""m_FrontPostMachiningSize : int""")
    m_FrontPostMachiningDepth = property(_pcbnew.HOLE_INFO_m_FrontPostMachiningDepth_get, _pcbnew.HOLE_INFO_m_FrontPostMachiningDepth_set, doc=r"""m_FrontPostMachiningDepth : int""")
    m_FrontPostMachiningAngle = property(_pcbnew.HOLE_INFO_m_FrontPostMachiningAngle_get, _pcbnew.HOLE_INFO_m_FrontPostMachiningAngle_set, doc=r"""m_FrontPostMachiningAngle : int""")
    m_BackPostMachining = property(_pcbnew.HOLE_INFO_m_BackPostMachining_get, _pcbnew.HOLE_INFO_m_BackPostMachining_set, doc=r"""m_BackPostMachining : PAD_DRILL_POST_MACHINING_MODE""")
    m_BackPostMachiningSize = property(_pcbnew.HOLE_INFO_m_BackPostMachiningSize_get, _pcbnew.HOLE_INFO_m_BackPostMachiningSize_set, doc=r"""m_BackPostMachiningSize : int""")
    m_BackPostMachiningDepth = property(_pcbnew.HOLE_INFO_m_BackPostMachiningDepth_get, _pcbnew.HOLE_INFO_m_BackPostMachiningDepth_set, doc=r"""m_BackPostMachiningDepth : int""")
    m_BackPostMachiningAngle = property(_pcbnew.HOLE_INFO_m_BackPostMachiningAngle_get, _pcbnew.HOLE_INFO_m_BackPostMachiningAngle_set, doc=r"""m_BackPostMachiningAngle : int""")
    m_DrillStart = property(_pcbnew.HOLE_INFO_m_DrillStart_get, _pcbnew.HOLE_INFO_m_DrillStart_set, doc=r"""m_DrillStart : PCB_LAYER_ID""")
    m_DrillEnd = property(_pcbnew.HOLE_INFO_m_DrillEnd_get, _pcbnew.HOLE_INFO_m_DrillEnd_set, doc=r"""m_DrillEnd : PCB_LAYER_ID""")
    m_StubLength = property(_pcbnew.HOLE_INFO_m_StubLength_get, _pcbnew.HOLE_INFO_m_StubLength_set, doc=r"""m_StubLength : std::optional<(int)>""")
    __swig_destroy__ = _pcbnew.delete_HOLE_INFO

# Register HOLE_INFO in _pcbnew:
_pcbnew.HOLE_INFO_swigregister(HOLE_INFO)
class DRILL_SPAN(object):
    r"""Proxy of C++ DRILL_SPAN class."""
    ...
    def __init__(self, *args):
        ...
        """
        _pcbnew.DRILL_SPAN_swiginit(self, _pcbnew.new_DRILL_SPAN(*args))

    def TopLayer(self):
        r"""TopLayer(DRILL_SPAN self) -> PCB_LAYER_ID"""
        return _pcbnew.DRILL_SPAN_TopLayer(self)

    def BottomLayer(self):
        r"""BottomLayer(DRILL_SPAN self) -> PCB_LAYER_ID"""
        return _pcbnew.DRILL_SPAN_BottomLayer(self)

    def DrillStartLayer(self):
        r"""DrillStartLayer(DRILL_SPAN self) -> PCB_LAYER_ID"""
        return _pcbnew.DRILL_SPAN_DrillStartLayer(self)

    def DrillEndLayer(self):
        r"""DrillEndLayer(DRILL_SPAN self) -> PCB_LAYER_ID"""
        return _pcbnew.DRILL_SPAN_DrillEndLayer(self)

    def Pair(self):
        r"""Pair(DRILL_SPAN self) -> DRILL_LAYER_PAIR"""
        return _pcbnew.DRILL_SPAN_Pair(self)

    def __lt__(self, aOther):
        r"""__lt__(DRILL_SPAN self, DRILL_SPAN aOther) -> bool"""
        return _pcbnew.DRILL_SPAN___lt__(self, aOther)
    m_StartLayer = property(_pcbnew.DRILL_SPAN_m_StartLayer_get, _pcbnew.DRILL_SPAN_m_StartLayer_set, doc=r"""m_StartLayer : PCB_LAYER_ID""")
    m_EndLayer = property(_pcbnew.DRILL_SPAN_m_EndLayer_get, _pcbnew.DRILL_SPAN_m_EndLayer_set, doc=r"""m_EndLayer : PCB_LAYER_ID""")
    m_IsBackdrill = property(_pcbnew.DRILL_SPAN_m_IsBackdrill_get, _pcbnew.DRILL_SPAN_m_IsBackdrill_set, doc=r"""m_IsBackdrill : bool""")
    m_IsNonPlatedFile = property(_pcbnew.DRILL_SPAN_m_IsNonPlatedFile_get, _pcbnew.DRILL_SPAN_m_IsNonPlatedFile_set, doc=r"""m_IsNonPlatedFile : bool""")
    __swig_destroy__ = _pcbnew.delete_DRILL_SPAN

# Register DRILL_SPAN in _pcbnew:
_pcbnew.DRILL_SPAN_swigregister(DRILL_SPAN)
...
class GENDRILL_WRITER_BASE(object):
    ...
    def GenDrillReportFile(self, aFullFileName, aReporter=None):
        r"""GenDrillReportFile(GENDRILL_WRITER_BASE self, wxString aFullFileName, REPORTER * aReporter=None) -> bool"""
        return _pcbnew.GENDRILL_WRITER_BASE_GenDrillReportFile(self, aFullFileName, aReporter)
...
ID_LANGUAGE_UKRAINIAN = _pcbnew.ID_LANGUAGE_UKRAINIAN

ID_LANGUAGE_ARABIC = _pcbnew.ID_LANGUAGE_ARABIC

ID_LANGUAGE_ESTONIAN = _pcbnew.ID_LANGUAGE_ESTONIAN

ID_LANGUAGE_FARSI = _pcbnew.ID_LANGUAGE_FARSI

ID_LANGUAGE_CROATIAN = _pcbnew.ID_LANGUAGE_CROATIAN

ID_LANGUAGE_ROMANIAN = _pcbnew.ID_LANGUAGE_ROMANIAN

ID_LANGUAGE_NORWEGIAN_BOKMAL = _pcbnew.ID_LANGUAGE_NORWEGIAN_BOKMAL

ID_LANGUAGE_TAMIL = _pcbnew.ID_LANGUAGE_TAMIL

ID_LANGUAGE_TELUGU = _pcbnew.ID_LANGUAGE_TELUGU

ID_LANGUAGE_HINDI = _pcbnew.ID_LANGUAGE_HINDI

ID_LANGUAGE_GEORGIAN = _pcbnew.ID_LANGUAGE_GEORGIAN
...
ID_ON_OVERRIDE_LOCKS = _pcbnew.ID_ON_OVERRIDE_LOCKS

ID_ON_LAYER_SELECT = _pcbnew.ID_ON_LAYER_SELECT
...
class LSET(BASE_SET):
    ...
    def ContainsAll(self, aLayers):
        r"""ContainsAll(LSET self, LSET aLayers) -> bool"""
        return _pcbnew.LSET_ContainsAll(self, aLayers)
...
class BOARD_ITEM(EDA_ITEM):
    ...
    def IsGroupableType(self):
        r"""IsGroupableType(BOARD_ITEM self) -> bool"""
        return _pcbnew.BOARD_ITEM_IsGroupableType(self)
    ...
    def Duplicate(self, addToParentGroup, aCommit=None):
        r"""Duplicate(BOARD_ITEM self, bool addToParentGroup, BOARD_COMMIT * aCommit=None) -> BOARD_ITEM"""
        return _pcbnew.BOARD_ITEM_Duplicate(self, addToParentGroup, aCommit)
    ...
    def GetMaxError(self):
        r"""GetMaxError(BOARD_ITEM self) -> int"""
        return _pcbnew.BOARD_ITEM_GetMaxError(self)

    def StyleFromSettings(self, settings, aCheckSide):
        r"""StyleFromSettings(BOARD_ITEM self, BOARD_DESIGN_SETTINGS settings, bool aCheckSide)"""
        return _pcbnew.BOARD_ITEM_StyleFromSettings(self, settings, aCheckSide)
    ...
    def TransformShapeToPolySet(self, aBuffer, aLayer, aClearance, aError, aErrorLoc, aRenderSettings=None):
        r"""TransformShapeToPolySet(BOARD_ITEM self, SHAPE_POLY_SET aBuffer, PCB_LAYER_ID aLayer, int aClearance, int aError, ERROR_LOC aErrorLoc, KIGFX::RENDER_SETTINGS * aRenderSettings=None)"""
        return _pcbnew.BOARD_ITEM_TransformShapeToPolySet(self, aBuffer, aLayer, aClearance, aError, aErrorLoc, aRenderSettings)

    def LayerMaskDescribe(self):
        r"""LayerMaskDescribe(BOARD_ITEM self) -> wxString"""
        return _pcbnew.BOARD_ITEM_LayerMaskDescribe(self)
...
CONNECTIVITY_CANDIDATE = _pcbnew.CONNECTIVITY_CANDIDATE
...
MCT_SKIP_STRUCT = _pcbnew.MCT_SKIP_STRUCT
...
SELECTION_CANDIDATE = _pcbnew.SELECTION_CANDIDATE


def EDAItemFlagsToString(flags):
    r"""EDAItemFlagsToString(EDA_ITEM_FLAGS flags) -> string"""
    return _pcbnew.EDAItemFlagsToString(flags)
class UNITS_PROVIDER(object):
    ...
    def MessageTextFromUnscaledValue(self, *args):
        r"""MessageTextFromUnscaledValue(UNITS_PROVIDER self, double aValue, bool aAddUnitLabel=True, EDA_DATA_TYPE aType=DISTANCE) -> wxString"""
        return _pcbnew.UNITS_PROVIDER_MessageTextFromUnscaledValue(self, *args)

    def MessageTextFromMinOptMax(self, *args):
        r"""MessageTextFromMinOptMax(UNITS_PROVIDER self, MINOPTMAX< int > const & aValue, EDA_DATA_TYPE aType=DISTANCE) -> wxString"""
        return _pcbnew.UNITS_PROVIDER_MessageTextFromMinOptMax(self, *args)
    ...
    def GetUnitsFromType(self, aType):
        r"""GetUnitsFromType(UNITS_PROVIDER self, EDA_DATA_TYPE aType) -> EDA_UNITS"""
        return _pcbnew.UNITS_PROVIDER_GetUnitsFromType(self, aType)

    @staticmethod
    def GetTypeFromUnits(aUnits):
        r"""GetTypeFromUnits(EDA_UNITS const aUnits) -> EDA_DATA_TYPE"""
        return _pcbnew.UNITS_PROVIDER_GetTypeFromUnits(aUnits)
...
BARCODE_T_CODE_39 = _pcbnew.BARCODE_T_CODE_39

BARCODE_T_CODE_128 = _pcbnew.BARCODE_T_CODE_128

BARCODE_T_DATA_MATRIX = _pcbnew.BARCODE_T_DATA_MATRIX

BARCODE_T_QR_CODE = _pcbnew.BARCODE_T_QR_CODE

BARCODE_T_MICRO_QR_CODE = _pcbnew.BARCODE_T_MICRO_QR_CODE

BARCODE_ECC_T_L = _pcbnew.BARCODE_ECC_T_L

BARCODE_ECC_T_M = _pcbnew.BARCODE_ECC_T_M

BARCODE_ECC_T_Q = _pcbnew.BARCODE_ECC_T_Q

BARCODE_ECC_T_H = _pcbnew.BARCODE_ECC_T_H

class PCB_BARCODE(BOARD_ITEM):
    r"""Proxy of C++ PCB_BARCODE class."""
    ...
    def __init__(self, *args):
        ...
        """
        _pcbnew.PCB_BARCODE_swiginit(self, _pcbnew.new_PCB_BARCODE(*args))
    __swig_destroy__ = _pcbnew.delete_PCB_BARCODE

    @staticmethod
    def ClassOf(aItem):
        r"""ClassOf(EDA_ITEM aItem) -> bool"""
        return _pcbnew.PCB_BARCODE_ClassOf(aItem)

    def SetTextSize(self, aTextSize):
        r"""SetTextSize(PCB_BARCODE self, int aTextSize)"""
        return _pcbnew.PCB_BARCODE_SetTextSize(self, aTextSize)

    def GetTextSize(self):
        r"""GetTextSize(PCB_BARCODE self) -> int"""
        return _pcbnew.PCB_BARCODE_GetTextSize(self)

    def Serialize(self, aContainer):
        r"""Serialize(PCB_BARCODE self, google::protobuf::Any & aContainer)"""
        return _pcbnew.PCB_BARCODE_Serialize(self, aContainer)

    def Deserialize(self, aContainer):
        r"""Deserialize(PCB_BARCODE self, google::protobuf::Any const & aContainer) -> bool"""
        return _pcbnew.PCB_BARCODE_Deserialize(self, aContainer)

    def GetWidth(self):
        r"""GetWidth(PCB_BARCODE self) -> int"""
        return _pcbnew.PCB_BARCODE_GetWidth(self)

    def SetWidth(self, aWidth):
        r"""SetWidth(PCB_BARCODE self, int aWidth)"""
        return _pcbnew.PCB_BARCODE_SetWidth(self, aWidth)

    def GetHeight(self):
        r"""GetHeight(PCB_BARCODE self) -> int"""
        return _pcbnew.PCB_BARCODE_GetHeight(self)

    def SetHeight(self, aHeight):
        r"""SetHeight(PCB_BARCODE self, int aHeight)"""
        return _pcbnew.PCB_BARCODE_SetHeight(self, aHeight)

    def GetMargin(self):
        r"""GetMargin(PCB_BARCODE self) -> VECTOR2I"""
        return _pcbnew.PCB_BARCODE_GetMargin(self)

    def SetMargin(self, aMargin):
        r"""SetMargin(PCB_BARCODE self, VECTOR2I aMargin)"""
        return _pcbnew.PCB_BARCODE_SetMargin(self, aMargin)

    def GetPolyShape(self):
        r"""GetPolyShape(PCB_BARCODE self) -> SHAPE_POLY_SET"""
        return _pcbnew.PCB_BARCODE_GetPolyShape(self)

    def GetSymbolPoly(self):
        r"""GetSymbolPoly(PCB_BARCODE self) -> SHAPE_POLY_SET"""
        return _pcbnew.PCB_BARCODE_GetSymbolPoly(self)

    def GetTextPoly(self):
        r"""GetTextPoly(PCB_BARCODE self) -> SHAPE_POLY_SET"""
        return _pcbnew.PCB_BARCODE_GetTextPoly(self)

    def TransformShapeToPolygon(self, aBuffer, aLayer, aClearance, aMaxError, aErrorLoc=ERROR_INSIDE, ignoreLineWidth=False):
        r"""TransformShapeToPolygon(PCB_BARCODE self, SHAPE_POLY_SET aBuffer, PCB_LAYER_ID aLayer, int aClearance, int aMaxError, ERROR_LOC aErrorLoc=ERROR_INSIDE, bool ignoreLineWidth=False)"""
        return _pcbnew.PCB_BARCODE_TransformShapeToPolygon(self, aBuffer, aLayer, aClearance, aMaxError, aErrorLoc, ignoreLineWidth)

    def GetEffectiveShape(self, *args):
        r"""GetEffectiveShape(PCB_BARCODE self, PCB_LAYER_ID aLayer=UNDEFINED_LAYER, FLASHING aFlash=DEFAULT) -> std::shared_ptr< SHAPE >"""
        return _pcbnew.PCB_BARCODE_GetEffectiveShape(self, *args)

    def GetBoundingHull(self, aBuffer, aLayer, aClearance, aMaxError, aErrorLoc=ERROR_INSIDE):
        r"""GetBoundingHull(PCB_BARCODE self, SHAPE_POLY_SET aBuffer, PCB_LAYER_ID aLayer, int aClearance, int aMaxError, ERROR_LOC aErrorLoc=ERROR_INSIDE)"""
        return _pcbnew.PCB_BARCODE_GetBoundingHull(self, aBuffer, aLayer, aClearance, aMaxError, aErrorLoc)

    def ComputeBarcode(self):
        r"""ComputeBarcode(PCB_BARCODE self)"""
        return _pcbnew.PCB_BARCODE_ComputeBarcode(self)

    def ComputeTextPoly(self):
        r"""ComputeTextPoly(PCB_BARCODE self)"""
        return _pcbnew.PCB_BARCODE_ComputeTextPoly(self)

    def AssembleBarcode(self):
        r"""AssembleBarcode(PCB_BARCODE self)"""
        return _pcbnew.PCB_BARCODE_AssembleBarcode(self)

    def SetText(self, aText):
        r"""SetText(PCB_BARCODE self, wxString aText)"""
        return _pcbnew.PCB_BARCODE_SetText(self, aText)

    def GetText(self):
        r"""GetText(PCB_BARCODE self) -> wxString"""
        return _pcbnew.PCB_BARCODE_GetText(self)

    def GetShownText(self):
        r"""GetShownText(PCB_BARCODE self) -> wxString"""
        return _pcbnew.PCB_BARCODE_GetShownText(self)
    ...
    def Text(self, *args):
        ...
        Text(PCB_BARCODE self) -> PCB_TEXT
        """
        return _pcbnew.PCB_BARCODE_Text(self, *args)

    def SetRect(self, aTopLeft, aBotRight):
        r"""SetRect(PCB_BARCODE self, VECTOR2I aTopLeft, VECTOR2I aBotRight)"""
        return _pcbnew.PCB_BARCODE_SetRect(self, aTopLeft, aBotRight)
    ...
    def HitTest(self, *args):
        ...
        """
        return _pcbnew.PCB_BARCODE_HitTest(self, *args)

    def GetClass(self):
        r"""GetClass(PCB_BARCODE self) -> wxString"""
        return _pcbnew.PCB_BARCODE_GetClass(self)

    def swapData(self, aImage):
        r"""swapData(PCB_BARCODE self, BOARD_ITEM aImage)"""
        return _pcbnew.PCB_BARCODE_swapData(self, aImage)

    @staticmethod
    def Compare(aBarcode, aOther):
        r"""Compare(PCB_BARCODE aBarcode, PCB_BARCODE aOther) -> int"""
        return _pcbnew.PCB_BARCODE_Compare(aBarcode, aOther)
    ...
    def __eq__(self, *args):
        ...
        """
        return _pcbnew.PCB_BARCODE___eq__(self, *args)

    def GetKind(self):
        r"""GetKind(PCB_BARCODE self) -> BARCODE_T"""
        return _pcbnew.PCB_BARCODE_GetKind(self)

    def SetKind(self, aKind):
        r"""SetKind(PCB_BARCODE self, BARCODE_T aKind)"""
        return _pcbnew.PCB_BARCODE_SetKind(self, aKind)

    def SetBarcodeKind(self, aKind):
        r"""SetBarcodeKind(PCB_BARCODE self, BARCODE_T aKind)"""
        return _pcbnew.PCB_BARCODE_SetBarcodeKind(self, aKind)

    def KeepSquare(self):
        r"""KeepSquare(PCB_BARCODE self) -> bool"""
        return _pcbnew.PCB_BARCODE_KeepSquare(self)

    def SetErrorCorrection(self, aErrorCorrection):
        r"""SetErrorCorrection(PCB_BARCODE self, BARCODE_ECC_T aErrorCorrection)"""
        return _pcbnew.PCB_BARCODE_SetErrorCorrection(self, aErrorCorrection)

    def GetErrorCorrection(self):
        r"""GetErrorCorrection(PCB_BARCODE self) -> BARCODE_ECC_T"""
        return _pcbnew.PCB_BARCODE_GetErrorCorrection(self)

    def SetBarcodeErrorCorrection(self, aErrorCorrection):
        r"""SetBarcodeErrorCorrection(PCB_BARCODE self, BARCODE_ECC_T aErrorCorrection)"""
        return _pcbnew.PCB_BARCODE_SetBarcodeErrorCorrection(self, aErrorCorrection)

    def SetBarcodeText(self, aText):
        r"""SetBarcodeText(PCB_BARCODE self, wxString aText)"""
        return _pcbnew.PCB_BARCODE_SetBarcodeText(self, aText)

    def SetShowText(self, aShow):
        r"""SetShowText(PCB_BARCODE self, bool aShow)"""
        return _pcbnew.PCB_BARCODE_SetShowText(self, aShow)

    def GetShowText(self):
        r"""GetShowText(PCB_BARCODE self) -> bool"""
        return _pcbnew.PCB_BARCODE_GetShowText(self)

    def SetBarcodeWidth(self, aWidth):
        r"""SetBarcodeWidth(PCB_BARCODE self, int aWidth)"""
        return _pcbnew.PCB_BARCODE_SetBarcodeWidth(self, aWidth)

    def SetBarcodeHeight(self, aHeight):
        r"""SetBarcodeHeight(PCB_BARCODE self, int aHeight)"""
        return _pcbnew.PCB_BARCODE_SetBarcodeHeight(self, aHeight)

    def GetAngle(self):
        r"""GetAngle(PCB_BARCODE self) -> EDA_ANGLE"""
        return _pcbnew.PCB_BARCODE_GetAngle(self)

    def GetOrientation(self):
        r"""GetOrientation(PCB_BARCODE self) -> double"""
        return _pcbnew.PCB_BARCODE_GetOrientation(self)

    def SetOrientation(self, aDegrees):
        r"""SetOrientation(PCB_BARCODE self, double aDegrees)"""
        return _pcbnew.PCB_BARCODE_SetOrientation(self, aDegrees)

    def GetMarginX(self):
        r"""GetMarginX(PCB_BARCODE self) -> int"""
        return _pcbnew.PCB_BARCODE_GetMarginX(self)

    def GetMarginY(self):
        r"""GetMarginY(PCB_BARCODE self) -> int"""
        return _pcbnew.PCB_BARCODE_GetMarginY(self)

    def SetMarginX(self, aX):
        r"""SetMarginX(PCB_BARCODE self, int aX)"""
        return _pcbnew.PCB_BARCODE_SetMarginX(self, aX)

    def SetMarginY(self, aY):
        r"""SetMarginY(PCB_BARCODE self, int aY)"""
        return _pcbnew.PCB_BARCODE_SetMarginY(self, aY)

    def GetLastError(self):
        r"""GetLastError(PCB_BARCODE self) -> wxString"""
        return _pcbnew.PCB_BARCODE_GetLastError(self)

# Register PCB_BARCODE in _pcbnew:
_pcbnew.PCB_BARCODE_swigregister(PCB_BARCODE)
...
def Cast_to_PCB_BARCODE(arg1):
    r"""Cast_to_PCB_BARCODE(BOARD_ITEM arg1) -> PCB_BARCODE"""
    return _pcbnew.Cast_to_PCB_BARCODE(arg1)
...
class BOARD_CONNECTED_ITEM(BOARD_ITEM):
    ...
    def UnpackNet(self, aProto):
        r"""UnpackNet(BOARD_CONNECTED_ITEM self, kiapi::board::types::Net const & aProto)"""
        return _pcbnew.BOARD_CONNECTED_ITEM_UnpackNet(self, aProto)

    def PackNet(self, aProto):
        r"""PackNet(BOARD_CONNECTED_ITEM self, kiapi::board::types::Net * aProto)"""
        return _pcbnew.BOARD_CONNECTED_ITEM_PackNet(self, aProto)
...
class BOARD_DESIGN_SETTINGS(object):
    ...
    def GetTrackWidthIndex(self):
        r"""GetTrackWidthIndex(BOARD_DESIGN_SETTINGS self) -> int"""
        return _pcbnew.BOARD_DESIGN_SETTINGS_GetTrackWidthIndex(self)

    def SetTrackWidthIndex(self, aIndex):
        r"""SetTrackWidthIndex(BOARD_DESIGN_SETTINGS self, int aIndex)"""
    ...
    def GetViaSizeIndex(self):
        r"""GetViaSizeIndex(BOARD_DESIGN_SETTINGS self) -> int"""
        return _pcbnew.BOARD_DESIGN_SETTINGS_GetViaSizeIndex(self)

    def SetViaSizeIndex(self, aIndex):
        r"""SetViaSizeIndex(BOARD_DESIGN_SETTINGS self, int aIndex)"""
    ...
    def GetDiffPairIndex(self):
        r"""GetDiffPairIndex(BOARD_DESIGN_SETTINGS self) -> int"""
        return _pcbnew.BOARD_DESIGN_SETTINGS_GetDiffPairIndex(self)

    def SetDiffPairIndex(self, aIndex):
        r"""SetDiffPairIndex(BOARD_DESIGN_SETTINGS self, int aIndex)"""
    ...
    m_ZoneLayerProperties = property(_pcbnew.BOARD_DESIGN_SETTINGS_m_ZoneLayerProperties_get, _pcbnew.BOARD_DESIGN_SETTINGS_m_ZoneLayerProperties_set, doc=r"""m_ZoneLayerProperties : std::map<(PCB_LAYER_ID,ZONE_LAYER_PROPERTIES,std::less<(PCB_LAYER_ID)>,std::allocator<(std::pair<(q(const).PCB_LAYER_ID,ZONE_LAYER_PROPERTIES)>)>)>""")
    ...
    m_StyleFPDimensions = property(_pcbnew.BOARD_DESIGN_SETTINGS_m_StyleFPDimensions_get, _pcbnew.BOARD_DESIGN_SETTINGS_m_StyleFPDimensions_set, doc=r"""m_StyleFPDimensions : bool""")
    m_StyleFPBarcodes = property(_pcbnew.BOARD_DESIGN_SETTINGS_m_StyleFPBarcodes_get, _pcbnew.BOARD_DESIGN_SETTINGS_m_StyleFPBarcodes_set, doc=r"""m_StyleFPBarcodes : bool""")
...
class NET_SETTINGS(object):
    ...
    def ForEachBusMember(aBusPattern, aFunction):
        r"""ForEachBusMember(wxString aBusPattern, std::function< void (wxString const &) > const & aFunction)"""
        return _pcbnew.NET_SETTINGS_ForEachBusMember(aBusPattern, aFunction)
...
class PCB_POINTS(object):
    r"""Proxy of C++ std::deque< PCB_POINT * > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        r"""iterator(PCB_POINTS self) -> SwigPyIterator"""
        return _pcbnew.PCB_POINTS_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        r"""__nonzero__(PCB_POINTS self) -> bool"""
        return _pcbnew.PCB_POINTS___nonzero__(self)

    def __bool__(self):
        r"""__bool__(PCB_POINTS self) -> bool"""
        return _pcbnew.PCB_POINTS___bool__(self)

    def __len__(self):
        r"""__len__(PCB_POINTS self) -> std::deque< PCB_POINT * >::size_type"""
        return _pcbnew.PCB_POINTS___len__(self)

    def __getslice__(self, i, j):
        r"""__getslice__(PCB_POINTS self, std::deque< PCB_POINT * >::difference_type i, std::deque< PCB_POINT * >::difference_type j) -> PCB_POINTS"""
        return _pcbnew.PCB_POINTS___getslice__(self, i, j)

    def __setslice__(self, *args):
        r"""
        __setslice__(PCB_POINTS self, std::deque< PCB_POINT * >::difference_type i, std::deque< PCB_POINT * >::difference_type j)
        __setslice__(PCB_POINTS self, std::deque< PCB_POINT * >::difference_type i, std::deque< PCB_POINT * >::difference_type j, PCB_POINTS v)
        """
        return _pcbnew.PCB_POINTS___setslice__(self, *args)

    def __delslice__(self, i, j):
        r"""__delslice__(PCB_POINTS self, std::deque< PCB_POINT * >::difference_type i, std::deque< PCB_POINT * >::difference_type j)"""
        return _pcbnew.PCB_POINTS___delslice__(self, i, j)

    def __delitem__(self, *args):
        r"""
        __delitem__(PCB_POINTS self, std::deque< PCB_POINT * >::difference_type i)
        __delitem__(PCB_POINTS self, SWIGPY_SLICEOBJECT * slice)
        """
        return _pcbnew.PCB_POINTS___delitem__(self, *args)

    def __getitem__(self, *args):
        r"""
        __getitem__(PCB_POINTS self, SWIGPY_SLICEOBJECT * slice) -> PCB_POINTS
        __getitem__(PCB_POINTS self, std::deque< PCB_POINT * >::difference_type i) -> std::deque< PCB_POINT * >::value_type
        """
        return _pcbnew.PCB_POINTS___getitem__(self, *args)

    def __setitem__(self, *args):
        r"""
        __setitem__(PCB_POINTS self, SWIGPY_SLICEOBJECT * slice, PCB_POINTS v)
        __setitem__(PCB_POINTS self, SWIGPY_SLICEOBJECT * slice)
        __setitem__(PCB_POINTS self, std::deque< PCB_POINT * >::difference_type i, std::deque< PCB_POINT * >::value_type x)
        """
        return _pcbnew.PCB_POINTS___setitem__(self, *args)

    def pop(self):
        r"""pop(PCB_POINTS self) -> std::deque< PCB_POINT * >::value_type"""
        return _pcbnew.PCB_POINTS_pop(self)

    def append(self, x):
        r"""append(PCB_POINTS self, std::deque< PCB_POINT * >::value_type x)"""
        return _pcbnew.PCB_POINTS_append(self, x)

    def empty(self):
        r"""empty(PCB_POINTS self) -> bool"""
        return _pcbnew.PCB_POINTS_empty(self)

    def size(self):
        r"""size(PCB_POINTS self) -> std::deque< PCB_POINT * >::size_type"""
        return _pcbnew.PCB_POINTS_size(self)

    def swap(self, v):
        r"""swap(PCB_POINTS self, PCB_POINTS v)"""
        return _pcbnew.PCB_POINTS_swap(self, v)

    def begin(self):
        r"""begin(PCB_POINTS self) -> std::deque< PCB_POINT * >::iterator"""
        return _pcbnew.PCB_POINTS_begin(self)

    def end(self):
        r"""end(PCB_POINTS self) -> std::deque< PCB_POINT * >::iterator"""
        return _pcbnew.PCB_POINTS_end(self)

    def rbegin(self):
        r"""rbegin(PCB_POINTS self) -> std::deque< PCB_POINT * >::reverse_iterator"""
        return _pcbnew.PCB_POINTS_rbegin(self)

    def rend(self):
        r"""rend(PCB_POINTS self) -> std::deque< PCB_POINT * >::reverse_iterator"""
        return _pcbnew.PCB_POINTS_rend(self)

    def clear(self):
        r"""clear(PCB_POINTS self)"""
        return _pcbnew.PCB_POINTS_clear(self)

    def get_allocator(self):
        r"""get_allocator(PCB_POINTS self) -> std::deque< PCB_POINT * >::allocator_type"""
        return _pcbnew.PCB_POINTS_get_allocator(self)

    def pop_back(self):
        r"""pop_back(PCB_POINTS self)"""
        return _pcbnew.PCB_POINTS_pop_back(self)

    def erase(self, *args):
        r"""
        erase(PCB_POINTS self, std::deque< PCB_POINT * >::iterator pos) -> std::deque< PCB_POINT * >::iterator
        erase(PCB_POINTS self, std::deque< PCB_POINT * >::iterator first, std::deque< PCB_POINT * >::iterator last) -> std::deque< PCB_POINT * >::iterator
        """
        return _pcbnew.PCB_POINTS_erase(self, *args)

    def __init__(self, *args):
        r"""
        __init__(PCB_POINTS self) -> PCB_POINTS
        __init__(PCB_POINTS self, PCB_POINTS other) -> PCB_POINTS
        __init__(PCB_POINTS self, std::deque< PCB_POINT * >::size_type size) -> PCB_POINTS
        __init__(PCB_POINTS self, std::deque< PCB_POINT * >::size_type size, std::deque< PCB_POINT * >::value_type value) -> PCB_POINTS
        """
        _pcbnew.PCB_POINTS_swiginit(self, _pcbnew.new_PCB_POINTS(*args))

    def push_back(self, x):
        r"""push_back(PCB_POINTS self, std::deque< PCB_POINT * >::value_type x)"""
        return _pcbnew.PCB_POINTS_push_back(self, x)

    def front(self):
        r"""front(PCB_POINTS self) -> std::deque< PCB_POINT * >::value_type"""
        return _pcbnew.PCB_POINTS_front(self)

    def back(self):
        r"""back(PCB_POINTS self) -> std::deque< PCB_POINT * >::value_type"""
        return _pcbnew.PCB_POINTS_back(self)

    def assign(self, n, x):
        r"""assign(PCB_POINTS self, std::deque< PCB_POINT * >::size_type n, std::deque< PCB_POINT * >::value_type x)"""
        return _pcbnew.PCB_POINTS_assign(self, n, x)

    def resize(self, *args):
        r"""
        resize(PCB_POINTS self, std::deque< PCB_POINT * >::size_type new_size)
        resize(PCB_POINTS self, std::deque< PCB_POINT * >::size_type new_size, std::deque< PCB_POINT * >::value_type x)
        """
        return _pcbnew.PCB_POINTS_resize(self, *args)

    def insert(self, *args):
        r"""
        insert(PCB_POINTS self, std::deque< PCB_POINT * >::iterator pos, std::deque< PCB_POINT * >::value_type x) -> std::deque< PCB_POINT * >::iterator
        insert(PCB_POINTS self, std::deque< PCB_POINT * >::iterator pos, std::deque< PCB_POINT * >::size_type n, std::deque< PCB_POINT * >::value_type x)
        """
        return _pcbnew.PCB_POINTS_insert(self, *args)

    def pop_front(self):
        r"""pop_front(PCB_POINTS self)"""
        return _pcbnew.PCB_POINTS_pop_front(self)

    def push_front(self, x):
        r"""push_front(PCB_POINTS self, std::deque< PCB_POINT * >::value_type x)"""
        return _pcbnew.PCB_POINTS_push_front(self, x)
    __swig_destroy__ = _pcbnew.delete_PCB_POINTS

# Register PCB_POINTS in _pcbnew:
_pcbnew.PCB_POINTS_swigregister(PCB_POINTS)
...
PAD_DRILL_POST_MACHINING_MODE_UNKNOWN = _pcbnew.PAD_DRILL_POST_MACHINING_MODE_UNKNOWN

PAD_DRILL_POST_MACHINING_MODE_NOT_POST_MACHINED = _pcbnew.PAD_DRILL_POST_MACHINING_MODE_NOT_POST_MACHINED

PAD_DRILL_POST_MACHINING_MODE_COUNTERBORE = _pcbnew.PAD_DRILL_POST_MACHINING_MODE_COUNTERBORE

PAD_DRILL_POST_MACHINING_MODE_COUNTERSINK = _pcbnew.PAD_DRILL_POST_MACHINING_MODE_COUNTERSINK

BACKDRILL_MODE_NO_BACKDRILL = _pcbnew.BACKDRILL_MODE_NO_BACKDRILL

BACKDRILL_MODE_BACKDRILL_BOTTOM = _pcbnew.BACKDRILL_MODE_BACKDRILL_BOTTOM

BACKDRILL_MODE_BACKDRILL_TOP = _pcbnew.BACKDRILL_MODE_BACKDRILL_TOP

BACKDRILL_MODE_BACKDRILL_BOTH = _pcbnew.BACKDRILL_MODE_BACKDRILL_BOTH
...
PAD_PROP_PRESSFIT = _pcbnew.PAD_PROP_PRESSFIT

UNCONNECTED_LAYER_MODE_KEEP_ALL = _pcbnew.UNCONNECTED_LAYER_MODE_KEEP_ALL

UNCONNECTED_LAYER_MODE_START_END_ONLY = _pcbnew.UNCONNECTED_LAYER_MODE_START_END_ONLY

UNCONNECTED_LAYER_MODE_REMOVE_ALL = _pcbnew.UNCONNECTED_LAYER_MODE_REMOVE_ALL

UNCONNECTED_LAYER_MODE_REMOVE_EXCEPT_START_AND_END = _pcbnew.UNCONNECTED_LAYER_MODE_REMOVE_EXCEPT_START_AND_END

CUSTOM_SHAPE_ZONE_MODE_OUTLINE = _pcbnew.CUSTOM_SHAPE_ZONE_MODE_OUTLINE

CUSTOM_SHAPE_ZONE_MODE_CONVEXHULL = _pcbnew.CUSTOM_SHAPE_ZONE_MODE_CONVEXHULL
...
class PADSTACK(object):
    ...
    def HasExplicitDefinitionForLayer(self, aLayer):
        r"""HasExplicitDefinitionForLayer(PADSTACK self, PCB_LAYER_ID aLayer) -> bool"""
        return _pcbnew.PADSTACK_HasExplicitDefinitionForLayer(self, aLayer)
    ...
    def FlipLayers(self, aBoard):
        r"""FlipLayers(PADSTACK self, BOARD aBoard)"""
        return _pcbnew.PADSTACK_FlipLayers(self, aBoard)
    ...
    def CustomName(self):
        r"""CustomName(PADSTACK self) -> wxChar const *"""
        return _pcbnew.PADSTACK_CustomName(self)

    def SetCustomName(self, aCustomName):
        r"""SetCustomName(PADSTACK self, wxString aCustomName)"""
        return _pcbnew.PADSTACK_SetCustomName(self, aCustomName)
    ...
    def TertiaryDrill(self, *args):
        r"""
        TertiaryDrill(PADSTACK self) -> PADSTACK::DRILL_PROPS
        TertiaryDrill(PADSTACK self) -> PADSTACK::DRILL_PROPS const &
        """
        return _pcbnew.PADSTACK_TertiaryDrill(self, *args)

    def FrontPostMachining(self, *args):
        r"""
        ...
        """
        return _pcbnew.PADSTACK_FrontPostMachining(self, *args)

    def BackPostMachining(self, *args):
        r"""
        ...
        """
        return _pcbnew.PADSTACK_BackPostMachining(self, *args)

    def UnconnectedLayerMode(self):
        r"""UnconnectedLayerMode(PADSTACK self) -> UNCONNECTED_LAYER_MODE"""
        return _pcbnew.PADSTACK_UnconnectedLayerMode(self)

    def SetUnconnectedLayerMode(self, aMode):
        r"""SetUnconnectedLayerMode(PADSTACK self, UNCONNECTED_LAYER_MODE aMode)"""
    ...
    def CustomShapeInZoneMode(self):
        r"""CustomShapeInZoneMode(PADSTACK self) -> CUSTOM_SHAPE_ZONE_MODE"""
        return _pcbnew.PADSTACK_CustomShapeInZoneMode(self)

    def SetCustomShapeInZoneMode(self, aM):
        r"""SetCustomShapeInZoneMode(PADSTACK self, CUSTOM_SHAPE_ZONE_MODE aM)"""
    ...
    def GetBackdrillMode(self):
        r"""GetBackdrillMode(PADSTACK self) -> BACKDRILL_MODE"""
        return _pcbnew.PADSTACK_GetBackdrillMode(self)

    def SetBackdrillMode(self, aMode):
        r"""SetBackdrillMode(PADSTACK self, BACKDRILL_MODE aMode)"""
        return _pcbnew.PADSTACK_SetBackdrillMode(self, aMode)

    def GetBackdrillSize(self, aTop):
        r"""GetBackdrillSize(PADSTACK self, bool aTop) -> std::optional< int >"""
        return _pcbnew.PADSTACK_GetBackdrillSize(self, aTop)

    def SetBackdrillSize(self, aTop, aSize):
        r"""SetBackdrillSize(PADSTACK self, bool aTop, std::optional< int > aSize)"""
        return _pcbnew.PADSTACK_SetBackdrillSize(self, aTop, aSize)

    def GetBackdrillEndLayer(self, aTop):
        r"""GetBackdrillEndLayer(PADSTACK self, bool aTop) -> PCB_LAYER_ID"""
        return _pcbnew.PADSTACK_GetBackdrillEndLayer(self, aTop)

    def SetBackdrillEndLayer(self, aTop, aLayer):
        r"""SetBackdrillEndLayer(PADSTACK self, bool aTop, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PADSTACK_SetBackdrillEndLayer(self, aTop, aLayer)
...
class PAD(BOARD_CONNECTED_ITEM):
    ...
    def GetCustomShapeInZoneOpt(self):
        r"""GetCustomShapeInZoneOpt(PAD self) -> CUSTOM_SHAPE_ZONE_MODE"""
        return _pcbnew.PAD_GetCustomShapeInZoneOpt(self)

    def SetCustomShapeInZoneOpt(self, aOption):
        r"""SetCustomShapeInZoneOpt(PAD self, CUSTOM_SHAPE_ZONE_MODE aOption)"""
    ...
    def HasExplicitDefinitionForLayer(self, aLayer):
        r"""HasExplicitDefinitionForLayer(PAD self, PCB_LAYER_ID aLayer) -> bool"""
        return _pcbnew.PAD_HasExplicitDefinitionForLayer(self, aLayer)
    ...
    def SetPrimaryDrillSize(self, aSize):
        r"""SetPrimaryDrillSize(PAD self, VECTOR2I aSize)"""
        return _pcbnew.PAD_SetPrimaryDrillSize(self, aSize)

    def GetPrimaryDrillSize(self):
        r"""GetPrimaryDrillSize(PAD self) -> VECTOR2I"""
        return _pcbnew.PAD_GetPrimaryDrillSize(self)

    def SetPrimaryDrillSizeX(self, aX):
        r"""SetPrimaryDrillSizeX(PAD self, int aX)"""
        return _pcbnew.PAD_SetPrimaryDrillSizeX(self, aX)

    def GetPrimaryDrillSizeX(self):
        r"""GetPrimaryDrillSizeX(PAD self) -> int"""
        return _pcbnew.PAD_GetPrimaryDrillSizeX(self)

    def SetPrimaryDrillSizeY(self, aY):
        r"""SetPrimaryDrillSizeY(PAD self, int aY)"""
        return _pcbnew.PAD_SetPrimaryDrillSizeY(self, aY)

    def GetPrimaryDrillSizeY(self):
        r"""GetPrimaryDrillSizeY(PAD self) -> int"""
        return _pcbnew.PAD_GetPrimaryDrillSizeY(self)
    ...
    def SetDrillSizeX(self, aX):
        r"""SetDrillSizeX(PAD self, int aX)"""
    ...
    def SetDrillSizeY(self, aY):
        r"""SetDrillSizeY(PAD self, int aY)"""
    ...
    def SetPrimaryDrillShape(self, aShape):
        r"""SetPrimaryDrillShape(PAD self, PAD_DRILL_SHAPE aShape)"""
        return _pcbnew.PAD_SetPrimaryDrillShape(self, aShape)

    def GetPrimaryDrillShape(self):
        r"""GetPrimaryDrillShape(PAD self) -> PAD_DRILL_SHAPE"""
        return _pcbnew.PAD_GetPrimaryDrillShape(self)
    ...
    def SetPrimaryDrillStartLayer(self, aLayer):
        r"""SetPrimaryDrillStartLayer(PAD self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PAD_SetPrimaryDrillStartLayer(self, aLayer)

    def GetPrimaryDrillStartLayer(self):
        r"""GetPrimaryDrillStartLayer(PAD self) -> PCB_LAYER_ID"""
        return _pcbnew.PAD_GetPrimaryDrillStartLayer(self)

    def SetPrimaryDrillEndLayer(self, aLayer):
        r"""SetPrimaryDrillEndLayer(PAD self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PAD_SetPrimaryDrillEndLayer(self, aLayer)

    def GetPrimaryDrillEndLayer(self):
        r"""GetPrimaryDrillEndLayer(PAD self) -> PCB_LAYER_ID"""
        return _pcbnew.PAD_GetPrimaryDrillEndLayer(self)

    def SetFrontPostMachining(self, aMode):
        r"""SetFrontPostMachining(PAD self, std::optional< PAD_DRILL_POST_MACHINING_MODE > const & aMode)"""
        return _pcbnew.PAD_SetFrontPostMachining(self, aMode)

    def GetFrontPostMachining(self):
        r"""GetFrontPostMachining(PAD self) -> std::optional< PAD_DRILL_POST_MACHINING_MODE >"""
        return _pcbnew.PAD_GetFrontPostMachining(self)

    def SetFrontPostMachiningMode(self, aMode):
        r"""SetFrontPostMachiningMode(PAD self, PAD_DRILL_POST_MACHINING_MODE aMode)"""
        return _pcbnew.PAD_SetFrontPostMachiningMode(self, aMode)

    def GetFrontPostMachiningMode(self):
        r"""GetFrontPostMachiningMode(PAD self) -> PAD_DRILL_POST_MACHINING_MODE"""
        return _pcbnew.PAD_GetFrontPostMachiningMode(self)

    def SetFrontPostMachiningSize(self, aSize):
        r"""SetFrontPostMachiningSize(PAD self, int aSize)"""
        return _pcbnew.PAD_SetFrontPostMachiningSize(self, aSize)

    def GetFrontPostMachiningSize(self):
        r"""GetFrontPostMachiningSize(PAD self) -> int"""
        return _pcbnew.PAD_GetFrontPostMachiningSize(self)

    def SetFrontPostMachiningDepth(self, aDepth):
        r"""SetFrontPostMachiningDepth(PAD self, int aDepth)"""
        return _pcbnew.PAD_SetFrontPostMachiningDepth(self, aDepth)

    def GetFrontPostMachiningDepth(self):
        r"""GetFrontPostMachiningDepth(PAD self) -> int"""
        return _pcbnew.PAD_GetFrontPostMachiningDepth(self)

    def SetFrontPostMachiningAngle(self, aAngle):
        r"""SetFrontPostMachiningAngle(PAD self, int aAngle)"""
        return _pcbnew.PAD_SetFrontPostMachiningAngle(self, aAngle)

    def GetFrontPostMachiningAngle(self):
        r"""GetFrontPostMachiningAngle(PAD self) -> int"""
        return _pcbnew.PAD_GetFrontPostMachiningAngle(self)

    def SetBackPostMachining(self, aMode):
        r"""SetBackPostMachining(PAD self, std::optional< PAD_DRILL_POST_MACHINING_MODE > const & aMode)"""
        return _pcbnew.PAD_SetBackPostMachining(self, aMode)

    def GetBackPostMachining(self):
        r"""GetBackPostMachining(PAD self) -> std::optional< PAD_DRILL_POST_MACHINING_MODE >"""
        return _pcbnew.PAD_GetBackPostMachining(self)

    def SetBackPostMachiningMode(self, aMode):
        r"""SetBackPostMachiningMode(PAD self, PAD_DRILL_POST_MACHINING_MODE aMode)"""
        return _pcbnew.PAD_SetBackPostMachiningMode(self, aMode)

    def GetBackPostMachiningMode(self):
        r"""GetBackPostMachiningMode(PAD self) -> PAD_DRILL_POST_MACHINING_MODE"""
        return _pcbnew.PAD_GetBackPostMachiningMode(self)

    def SetBackPostMachiningSize(self, aSize):
        r"""SetBackPostMachiningSize(PAD self, int aSize)"""
        return _pcbnew.PAD_SetBackPostMachiningSize(self, aSize)

    def GetBackPostMachiningSize(self):
        r"""GetBackPostMachiningSize(PAD self) -> int"""
        return _pcbnew.PAD_GetBackPostMachiningSize(self)

    def SetBackPostMachiningDepth(self, aDepth):
        r"""SetBackPostMachiningDepth(PAD self, int aDepth)"""
        return _pcbnew.PAD_SetBackPostMachiningDepth(self, aDepth)

    def GetBackPostMachiningDepth(self):
        r"""GetBackPostMachiningDepth(PAD self) -> int"""
        return _pcbnew.PAD_GetBackPostMachiningDepth(self)

    def SetBackPostMachiningAngle(self, aAngle):
        r"""SetBackPostMachiningAngle(PAD self, int aAngle)"""
        return _pcbnew.PAD_SetBackPostMachiningAngle(self, aAngle)

    def GetBackPostMachiningAngle(self):
        r"""GetBackPostMachiningAngle(PAD self) -> int"""
        return _pcbnew.PAD_GetBackPostMachiningAngle(self)

    def IsBackdrilledOrPostMachined(self, aLayer):
        r"""IsBackdrilledOrPostMachined(PAD self, PCB_LAYER_ID aLayer) -> bool"""
        return _pcbnew.PAD_IsBackdrilledOrPostMachined(self, aLayer)

    def GetPostMachiningKnockout(self, aLayer):
        r"""GetPostMachiningKnockout(PAD self, PCB_LAYER_ID aLayer) -> int"""
        return _pcbnew.PAD_GetPostMachiningKnockout(self, aLayer)

    def SetPrimaryDrillFilled(self, aFilled):
        r"""SetPrimaryDrillFilled(PAD self, std::optional< bool > const & aFilled)"""
        return _pcbnew.PAD_SetPrimaryDrillFilled(self, aFilled)

    def SetPrimaryDrillFilledFlag(self, aFilled):
        r"""SetPrimaryDrillFilledFlag(PAD self, bool aFilled)"""
        return _pcbnew.PAD_SetPrimaryDrillFilledFlag(self, aFilled)

    def GetPrimaryDrillFilled(self):
        r"""GetPrimaryDrillFilled(PAD self) -> std::optional< bool >"""
        return _pcbnew.PAD_GetPrimaryDrillFilled(self)

    def GetPrimaryDrillFilledFlag(self):
        r"""GetPrimaryDrillFilledFlag(PAD self) -> bool"""
        return _pcbnew.PAD_GetPrimaryDrillFilledFlag(self)

    def SetPrimaryDrillCapped(self, aCapped):
        r"""SetPrimaryDrillCapped(PAD self, std::optional< bool > const & aCapped)"""
        return _pcbnew.PAD_SetPrimaryDrillCapped(self, aCapped)

    def SetPrimaryDrillCappedFlag(self, aCapped):
        r"""SetPrimaryDrillCappedFlag(PAD self, bool aCapped)"""
        return _pcbnew.PAD_SetPrimaryDrillCappedFlag(self, aCapped)

    def GetPrimaryDrillCapped(self):
        r"""GetPrimaryDrillCapped(PAD self) -> std::optional< bool >"""
        return _pcbnew.PAD_GetPrimaryDrillCapped(self)

    def GetPrimaryDrillCappedFlag(self):
        r"""GetPrimaryDrillCappedFlag(PAD self) -> bool"""
        return _pcbnew.PAD_GetPrimaryDrillCappedFlag(self)

    def SetSecondaryDrillSize(self, aSize):
        r"""SetSecondaryDrillSize(PAD self, VECTOR2I aSize)"""
        return _pcbnew.PAD_SetSecondaryDrillSize(self, aSize)

    def GetSecondaryDrillSize(self):
        r"""GetSecondaryDrillSize(PAD self) -> VECTOR2I"""
        return _pcbnew.PAD_GetSecondaryDrillSize(self)

    def ClearSecondaryDrillSize(self):
        r"""ClearSecondaryDrillSize(PAD self)"""
        return _pcbnew.PAD_ClearSecondaryDrillSize(self)

    def SetSecondaryDrillSizeX(self, aX):
        r"""SetSecondaryDrillSizeX(PAD self, int aX)"""
        return _pcbnew.PAD_SetSecondaryDrillSizeX(self, aX)

    def GetSecondaryDrillSizeX(self):
        r"""GetSecondaryDrillSizeX(PAD self) -> int"""
        return _pcbnew.PAD_GetSecondaryDrillSizeX(self)

    def SetSecondaryDrillSizeY(self, aY):
        r"""SetSecondaryDrillSizeY(PAD self, int aY)"""
        return _pcbnew.PAD_SetSecondaryDrillSizeY(self, aY)

    def GetSecondaryDrillSizeY(self):
        r"""GetSecondaryDrillSizeY(PAD self) -> int"""
        return _pcbnew.PAD_GetSecondaryDrillSizeY(self)

    def SetSecondaryDrillShape(self, aShape):
        r"""SetSecondaryDrillShape(PAD self, PAD_DRILL_SHAPE aShape)"""
        return _pcbnew.PAD_SetSecondaryDrillShape(self, aShape)

    def GetSecondaryDrillShape(self):
        r"""GetSecondaryDrillShape(PAD self) -> PAD_DRILL_SHAPE"""
        return _pcbnew.PAD_GetSecondaryDrillShape(self)

    def SetSecondaryDrillStartLayer(self, aLayer):
        r"""SetSecondaryDrillStartLayer(PAD self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PAD_SetSecondaryDrillStartLayer(self, aLayer)

    def GetSecondaryDrillStartLayer(self):
        r"""GetSecondaryDrillStartLayer(PAD self) -> PCB_LAYER_ID"""
        return _pcbnew.PAD_GetSecondaryDrillStartLayer(self)

    def SetSecondaryDrillEndLayer(self, aLayer):
        r"""SetSecondaryDrillEndLayer(PAD self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PAD_SetSecondaryDrillEndLayer(self, aLayer)

    def GetSecondaryDrillEndLayer(self):
        r"""GetSecondaryDrillEndLayer(PAD self) -> PCB_LAYER_ID"""
        return _pcbnew.PAD_GetSecondaryDrillEndLayer(self)

    def SetTertiaryDrillSize(self, aSize):
        r"""SetTertiaryDrillSize(PAD self, VECTOR2I aSize)"""
        return _pcbnew.PAD_SetTertiaryDrillSize(self, aSize)

    def GetTertiaryDrillSize(self):
        r"""GetTertiaryDrillSize(PAD self) -> VECTOR2I"""
        return _pcbnew.PAD_GetTertiaryDrillSize(self)

    def ClearTertiaryDrillSize(self):
        r"""ClearTertiaryDrillSize(PAD self)"""
        return _pcbnew.PAD_ClearTertiaryDrillSize(self)

    def SetTertiaryDrillSizeX(self, aX):
        r"""SetTertiaryDrillSizeX(PAD self, int aX)"""
        return _pcbnew.PAD_SetTertiaryDrillSizeX(self, aX)

    def GetTertiaryDrillSizeX(self):
        r"""GetTertiaryDrillSizeX(PAD self) -> int"""
        return _pcbnew.PAD_GetTertiaryDrillSizeX(self)

    def SetTertiaryDrillSizeY(self, aY):
        r"""SetTertiaryDrillSizeY(PAD self, int aY)"""
        return _pcbnew.PAD_SetTertiaryDrillSizeY(self, aY)

    def GetTertiaryDrillSizeY(self):
        r"""GetTertiaryDrillSizeY(PAD self) -> int"""
        return _pcbnew.PAD_GetTertiaryDrillSizeY(self)

    def SetTertiaryDrillShape(self, aShape):
        r"""SetTertiaryDrillShape(PAD self, PAD_DRILL_SHAPE aShape)"""
        return _pcbnew.PAD_SetTertiaryDrillShape(self, aShape)

    def GetTertiaryDrillShape(self):
        r"""GetTertiaryDrillShape(PAD self) -> PAD_DRILL_SHAPE"""
        return _pcbnew.PAD_GetTertiaryDrillShape(self)

    def SetTertiaryDrillStartLayer(self, aLayer):
        r"""SetTertiaryDrillStartLayer(PAD self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PAD_SetTertiaryDrillStartLayer(self, aLayer)

    def GetTertiaryDrillStartLayer(self):
        r"""GetTertiaryDrillStartLayer(PAD self) -> PCB_LAYER_ID"""
        return _pcbnew.PAD_GetTertiaryDrillStartLayer(self)

    def SetTertiaryDrillEndLayer(self, aLayer):
        r"""SetTertiaryDrillEndLayer(PAD self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PAD_SetTertiaryDrillEndLayer(self, aLayer)

    def GetTertiaryDrillEndLayer(self):
        r"""GetTertiaryDrillEndLayer(PAD self) -> PCB_LAYER_ID"""
        return _pcbnew.PAD_GetTertiaryDrillEndLayer(self)
    ...
    def IsNPTHWithNoCopper(self):
        r"""IsNPTHWithNoCopper(PAD self) -> bool"""
        return _pcbnew.PAD_IsNPTHWithNoCopper(self)
    ...
    def SetPadToDieDelay(self, aDelay):
        r"""SetPadToDieDelay(PAD self, int aDelay)"""
        return _pcbnew.PAD_SetPadToDieDelay(self, aDelay)

    def GetPadToDieDelay(self):
        r"""GetPadToDieDelay(PAD self) -> int"""
        return _pcbnew.PAD_GetPadToDieDelay(self)
    ...
    @staticmethod
    def SwapShapePositions(aLhs, aRhs):
        r"""SwapShapePositions(PAD aLhs, PAD aRhs)"""
        return _pcbnew.PAD_SwapShapePositions(aLhs, aRhs)
    ...
    def SetUnconnectedLayerMode(self, aMode):
        r"""SetUnconnectedLayerMode(PAD self, UNCONNECTED_LAYER_MODE aMode)"""
        return _pcbnew.PAD_SetUnconnectedLayerMode(self, aMode)

    def GetUnconnectedLayerMode(self):
        r"""GetUnconnectedLayerMode(PAD self) -> UNCONNECTED_LAYER_MODE"""
    ...
    def GetBoundingBox(self, *args):
        ...
        """
        return _pcbnew.PAD_GetBoundingBox(self, *args)
    ...
    def ShowPadShape(self, *args):
        r"""
        ShowPadShape(PAD self, PAD_SHAPE aShape) -> wxString
        ShowPadShape(PAD self, PCB_LAYER_ID aLayer) -> wxString
        """
        return _pcbnew.PAD_ShowPadShape(self, *args)

    def ShowLegacyPadShape(self, aLayer):
        r"""ShowLegacyPadShape(PAD self, PCB_LAYER_ID aLayer) -> wxString"""
        return _pcbnew.PAD_ShowLegacyPadShape(self, aLayer)
    ...
    def GetBackdrillMode(self):
        r"""GetBackdrillMode(PAD self) -> BACKDRILL_MODE"""
        return _pcbnew.PAD_GetBackdrillMode(self)

    def SetBackdrillMode(self, aMode):
        r"""SetBackdrillMode(PAD self, BACKDRILL_MODE aMode)"""
        return _pcbnew.PAD_SetBackdrillMode(self, aMode)

    def GetBottomBackdrillSize(self):
        r"""GetBottomBackdrillSize(PAD self) -> std::optional< int >"""
        return _pcbnew.PAD_GetBottomBackdrillSize(self)

    def SetBottomBackdrillSize(self, aSize):
        r"""SetBottomBackdrillSize(PAD self, std::optional< int > aSize)"""
        return _pcbnew.PAD_SetBottomBackdrillSize(self, aSize)

    def GetBottomBackdrillLayer(self):
        r"""GetBottomBackdrillLayer(PAD self) -> PCB_LAYER_ID"""
        return _pcbnew.PAD_GetBottomBackdrillLayer(self)

    def SetBottomBackdrillLayer(self, aLayer):
        r"""SetBottomBackdrillLayer(PAD self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PAD_SetBottomBackdrillLayer(self, aLayer)

    def GetTopBackdrillSize(self):
        r"""GetTopBackdrillSize(PAD self) -> std::optional< int >"""
        return _pcbnew.PAD_GetTopBackdrillSize(self)

    def SetTopBackdrillSize(self, aSize):
        r"""SetTopBackdrillSize(PAD self, std::optional< int > aSize)"""
        return _pcbnew.PAD_SetTopBackdrillSize(self, aSize)

    def GetTopBackdrillLayer(self):
        r"""GetTopBackdrillLayer(PAD self) -> PCB_LAYER_ID"""
        return _pcbnew.PAD_GetTopBackdrillLayer(self)

    def SetTopBackdrillLayer(self, aLayer):
        r"""SetTopBackdrillLayer(PAD self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PAD_SetTopBackdrillLayer(self, aLayer)
...
class PCB_TRACK(BOARD_CONNECTED_ITEM):
    ...
    def GetDelay(self):
        r"""GetDelay(PCB_TRACK self) -> double"""
        return _pcbnew.PCB_TRACK_GetDelay(self)
    ...
    def HitTest(self, *args):
        ...
        HitTest(PCB_TRACK self, SHAPE_LINE_CHAIN aPoly, bool aContained) -> bool
        """
...
class PCB_VIA(PCB_TRACK):
    ...
    def GetBackdrillMode(self):
        r"""GetBackdrillMode(PCB_VIA self) -> BACKDRILL_MODE"""
        return _pcbnew.PCB_VIA_GetBackdrillMode(self)

    def SetBackdrillMode(self, aMode):
        r"""SetBackdrillMode(PCB_VIA self, BACKDRILL_MODE aMode)"""
        return _pcbnew.PCB_VIA_SetBackdrillMode(self, aMode)

    def GetBottomBackdrillSize(self):
        r"""GetBottomBackdrillSize(PCB_VIA self) -> std::optional< int >"""
        return _pcbnew.PCB_VIA_GetBottomBackdrillSize(self)

    def SetBottomBackdrillSize(self, aSize):
        r"""SetBottomBackdrillSize(PCB_VIA self, std::optional< int > aSize)"""
        return _pcbnew.PCB_VIA_SetBottomBackdrillSize(self, aSize)

    def GetBottomBackdrillLayer(self):
        r"""GetBottomBackdrillLayer(PCB_VIA self) -> PCB_LAYER_ID"""
        return _pcbnew.PCB_VIA_GetBottomBackdrillLayer(self)

    def SetBottomBackdrillLayer(self, aLayer):
        r"""SetBottomBackdrillLayer(PCB_VIA self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PCB_VIA_SetBottomBackdrillLayer(self, aLayer)

    def GetTopBackdrillSize(self):
        r"""GetTopBackdrillSize(PCB_VIA self) -> std::optional< int >"""
        return _pcbnew.PCB_VIA_GetTopBackdrillSize(self)

    def SetTopBackdrillSize(self, aSize):
        r"""SetTopBackdrillSize(PCB_VIA self, std::optional< int > aSize)"""
        return _pcbnew.PCB_VIA_SetTopBackdrillSize(self, aSize)

    def GetTopBackdrillLayer(self):
        r"""GetTopBackdrillLayer(PCB_VIA self) -> PCB_LAYER_ID"""
        return _pcbnew.PCB_VIA_GetTopBackdrillLayer(self)

    def SetTopBackdrillLayer(self, aLayer):
        r"""SetTopBackdrillLayer(PCB_VIA self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PCB_VIA_SetTopBackdrillLayer(self, aLayer)

    def IsMicroVia(self):
        r"""IsMicroVia(PCB_VIA self) -> bool"""
        return _pcbnew.PCB_VIA_IsMicroVia(self)

    def IsBlindVia(self):
        r"""IsBlindVia(PCB_VIA self) -> bool"""
        return _pcbnew.PCB_VIA_IsBlindVia(self)

    def IsBuriedVia(self):
        r"""IsBuriedVia(PCB_VIA self) -> bool"""
        return _pcbnew.PCB_VIA_IsBuriedVia(self)

    @staticmethod
    def ValidateViaParameters(*args):
        ...
        return _pcbnew.PCB_VIA_ValidateViaParameters(*args)
    ...
    def GetBoundingBox(self, *args):
        ...
        """
        return _pcbnew.PCB_VIA_GetBoundingBox(self, *args)
    ...
    def SetPrimaryDrillSize(self, aSize):
        r"""SetPrimaryDrillSize(PCB_VIA self, VECTOR2I aSize)"""
        return _pcbnew.PCB_VIA_SetPrimaryDrillSize(self, aSize)

    def GetPrimaryDrillSize(self):
        r"""GetPrimaryDrillSize(PCB_VIA self) -> VECTOR2I"""
        return _pcbnew.PCB_VIA_GetPrimaryDrillSize(self)

    def SetPrimaryDrillShape(self, aShape):
        r"""SetPrimaryDrillShape(PCB_VIA self, PAD_DRILL_SHAPE aShape)"""
        return _pcbnew.PCB_VIA_SetPrimaryDrillShape(self, aShape)

    def GetPrimaryDrillShape(self):
        r"""GetPrimaryDrillShape(PCB_VIA self) -> PAD_DRILL_SHAPE"""
        return _pcbnew.PCB_VIA_GetPrimaryDrillShape(self)

    def SetPrimaryDrillStartLayer(self, aLayer):
        r"""SetPrimaryDrillStartLayer(PCB_VIA self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PCB_VIA_SetPrimaryDrillStartLayer(self, aLayer)

    def GetPrimaryDrillStartLayer(self):
        r"""GetPrimaryDrillStartLayer(PCB_VIA self) -> PCB_LAYER_ID"""
        return _pcbnew.PCB_VIA_GetPrimaryDrillStartLayer(self)

    def SetPrimaryDrillEndLayer(self, aLayer):
        r"""SetPrimaryDrillEndLayer(PCB_VIA self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PCB_VIA_SetPrimaryDrillEndLayer(self, aLayer)

    def GetPrimaryDrillEndLayer(self):
        r"""GetPrimaryDrillEndLayer(PCB_VIA self) -> PCB_LAYER_ID"""
        return _pcbnew.PCB_VIA_GetPrimaryDrillEndLayer(self)

    def SetFrontPostMachining(self, aMode):
        r"""SetFrontPostMachining(PCB_VIA self, std::optional< PAD_DRILL_POST_MACHINING_MODE > const & aMode)"""
        return _pcbnew.PCB_VIA_SetFrontPostMachining(self, aMode)

    def GetFrontPostMachining(self):
        r"""GetFrontPostMachining(PCB_VIA self) -> std::optional< PAD_DRILL_POST_MACHINING_MODE >"""
        return _pcbnew.PCB_VIA_GetFrontPostMachining(self)

    def SetFrontPostMachiningMode(self, aMode):
        r"""SetFrontPostMachiningMode(PCB_VIA self, PAD_DRILL_POST_MACHINING_MODE aMode)"""
        return _pcbnew.PCB_VIA_SetFrontPostMachiningMode(self, aMode)

    def GetFrontPostMachiningMode(self):
        r"""GetFrontPostMachiningMode(PCB_VIA self) -> PAD_DRILL_POST_MACHINING_MODE"""
        return _pcbnew.PCB_VIA_GetFrontPostMachiningMode(self)

    def SetFrontPostMachiningSize(self, aSize):
        r"""SetFrontPostMachiningSize(PCB_VIA self, int aSize)"""
        return _pcbnew.PCB_VIA_SetFrontPostMachiningSize(self, aSize)

    def GetFrontPostMachiningSize(self):
        r"""GetFrontPostMachiningSize(PCB_VIA self) -> int"""
        return _pcbnew.PCB_VIA_GetFrontPostMachiningSize(self)

    def SetFrontPostMachiningDepth(self, aDepth):
        r"""SetFrontPostMachiningDepth(PCB_VIA self, int aDepth)"""
        return _pcbnew.PCB_VIA_SetFrontPostMachiningDepth(self, aDepth)

    def GetFrontPostMachiningDepth(self):
        r"""GetFrontPostMachiningDepth(PCB_VIA self) -> int"""
        return _pcbnew.PCB_VIA_GetFrontPostMachiningDepth(self)

    def SetFrontPostMachiningAngle(self, aAngle):
        r"""SetFrontPostMachiningAngle(PCB_VIA self, int aAngle)"""
        return _pcbnew.PCB_VIA_SetFrontPostMachiningAngle(self, aAngle)

    def GetFrontPostMachiningAngle(self):
        r"""GetFrontPostMachiningAngle(PCB_VIA self) -> int"""
        return _pcbnew.PCB_VIA_GetFrontPostMachiningAngle(self)

    def SetBackPostMachining(self, aMode):
        r"""SetBackPostMachining(PCB_VIA self, std::optional< PAD_DRILL_POST_MACHINING_MODE > const & aMode)"""
        return _pcbnew.PCB_VIA_SetBackPostMachining(self, aMode)

    def GetBackPostMachining(self):
        r"""GetBackPostMachining(PCB_VIA self) -> std::optional< PAD_DRILL_POST_MACHINING_MODE >"""
        return _pcbnew.PCB_VIA_GetBackPostMachining(self)

    def SetBackPostMachiningMode(self, aMode):
        r"""SetBackPostMachiningMode(PCB_VIA self, PAD_DRILL_POST_MACHINING_MODE aMode)"""
        return _pcbnew.PCB_VIA_SetBackPostMachiningMode(self, aMode)

    def GetBackPostMachiningMode(self):
        r"""GetBackPostMachiningMode(PCB_VIA self) -> PAD_DRILL_POST_MACHINING_MODE"""
        return _pcbnew.PCB_VIA_GetBackPostMachiningMode(self)

    def SetBackPostMachiningSize(self, aSize):
        r"""SetBackPostMachiningSize(PCB_VIA self, int aSize)"""
        return _pcbnew.PCB_VIA_SetBackPostMachiningSize(self, aSize)

    def GetBackPostMachiningSize(self):
        r"""GetBackPostMachiningSize(PCB_VIA self) -> int"""
        return _pcbnew.PCB_VIA_GetBackPostMachiningSize(self)

    def SetBackPostMachiningDepth(self, aDepth):
        r"""SetBackPostMachiningDepth(PCB_VIA self, int aDepth)"""
        return _pcbnew.PCB_VIA_SetBackPostMachiningDepth(self, aDepth)

    def GetBackPostMachiningDepth(self):
        r"""GetBackPostMachiningDepth(PCB_VIA self) -> int"""
        return _pcbnew.PCB_VIA_GetBackPostMachiningDepth(self)

    def SetBackPostMachiningAngle(self, aAngle):
        r"""SetBackPostMachiningAngle(PCB_VIA self, int aAngle)"""
        return _pcbnew.PCB_VIA_SetBackPostMachiningAngle(self, aAngle)

    def GetBackPostMachiningAngle(self):
        r"""GetBackPostMachiningAngle(PCB_VIA self) -> int"""
        return _pcbnew.PCB_VIA_GetBackPostMachiningAngle(self)

    def IsBackdrilledOrPostMachined(self, aLayer):
        r"""IsBackdrilledOrPostMachined(PCB_VIA self, PCB_LAYER_ID aLayer) -> bool"""
        return _pcbnew.PCB_VIA_IsBackdrilledOrPostMachined(self, aLayer)

    def GetPostMachiningKnockout(self, aLayer):
        r"""GetPostMachiningKnockout(PCB_VIA self, PCB_LAYER_ID aLayer) -> int"""
        return _pcbnew.PCB_VIA_GetPostMachiningKnockout(self, aLayer)

    def SetPrimaryDrillFilled(self, aFilled):
        r"""SetPrimaryDrillFilled(PCB_VIA self, std::optional< bool > const & aFilled)"""
        return _pcbnew.PCB_VIA_SetPrimaryDrillFilled(self, aFilled)

    def SetPrimaryDrillFilledFlag(self, aFilled):
        r"""SetPrimaryDrillFilledFlag(PCB_VIA self, bool aFilled)"""
        return _pcbnew.PCB_VIA_SetPrimaryDrillFilledFlag(self, aFilled)

    def GetPrimaryDrillFilled(self):
        r"""GetPrimaryDrillFilled(PCB_VIA self) -> std::optional< bool >"""
        return _pcbnew.PCB_VIA_GetPrimaryDrillFilled(self)

    def GetPrimaryDrillFilledFlag(self):
        r"""GetPrimaryDrillFilledFlag(PCB_VIA self) -> bool"""
        return _pcbnew.PCB_VIA_GetPrimaryDrillFilledFlag(self)

    def SetPrimaryDrillCapped(self, aCapped):
        r"""SetPrimaryDrillCapped(PCB_VIA self, std::optional< bool > const & aCapped)"""
        return _pcbnew.PCB_VIA_SetPrimaryDrillCapped(self, aCapped)

    def SetPrimaryDrillCappedFlag(self, aCapped):
        r"""SetPrimaryDrillCappedFlag(PCB_VIA self, bool aCapped)"""
        return _pcbnew.PCB_VIA_SetPrimaryDrillCappedFlag(self, aCapped)

    def GetPrimaryDrillCapped(self):
        r"""GetPrimaryDrillCapped(PCB_VIA self) -> std::optional< bool >"""
        return _pcbnew.PCB_VIA_GetPrimaryDrillCapped(self)

    def GetPrimaryDrillCappedFlag(self):
        r"""GetPrimaryDrillCappedFlag(PCB_VIA self) -> bool"""
        return _pcbnew.PCB_VIA_GetPrimaryDrillCappedFlag(self)
    ...
    def ClearSecondaryDrillSize(self):
        r"""ClearSecondaryDrillSize(PCB_VIA self)"""
        return _pcbnew.PCB_VIA_ClearSecondaryDrillSize(self)

    def SetSecondaryDrillSize(self, *args):
        r"""
        SetSecondaryDrillSize(PCB_VIA self, VECTOR2I aSize)
        SetSecondaryDrillSize(PCB_VIA self, std::optional< int > const & aDrill)
        """
        return _pcbnew.PCB_VIA_SetSecondaryDrillSize(self, *args)

    def GetSecondaryDrillSize(self):
        r"""GetSecondaryDrillSize(PCB_VIA self) -> std::optional< int >"""
        return _pcbnew.PCB_VIA_GetSecondaryDrillSize(self)

    def SetSecondaryDrillStartLayer(self, aLayer):
        r"""SetSecondaryDrillStartLayer(PCB_VIA self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PCB_VIA_SetSecondaryDrillStartLayer(self, aLayer)

    def GetSecondaryDrillStartLayer(self):
        r"""GetSecondaryDrillStartLayer(PCB_VIA self) -> PCB_LAYER_ID"""
        return _pcbnew.PCB_VIA_GetSecondaryDrillStartLayer(self)

    def SetSecondaryDrillEndLayer(self, aLayer):
        r"""SetSecondaryDrillEndLayer(PCB_VIA self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PCB_VIA_SetSecondaryDrillEndLayer(self, aLayer)

    def GetSecondaryDrillEndLayer(self):
        r"""GetSecondaryDrillEndLayer(PCB_VIA self) -> PCB_LAYER_ID"""
        return _pcbnew.PCB_VIA_GetSecondaryDrillEndLayer(self)

    def SetSecondaryDrillShape(self, aShape):
        r"""SetSecondaryDrillShape(PCB_VIA self, PAD_DRILL_SHAPE aShape)"""
        return _pcbnew.PCB_VIA_SetSecondaryDrillShape(self, aShape)

    def GetSecondaryDrillShape(self):
        r"""GetSecondaryDrillShape(PCB_VIA self) -> PAD_DRILL_SHAPE"""
        return _pcbnew.PCB_VIA_GetSecondaryDrillShape(self)

    def ClearTertiaryDrillSize(self):
        r"""ClearTertiaryDrillSize(PCB_VIA self)"""
        return _pcbnew.PCB_VIA_ClearTertiaryDrillSize(self)

    def SetTertiaryDrillSize(self, *args):
        r"""
        SetTertiaryDrillSize(PCB_VIA self, VECTOR2I aSize)
        SetTertiaryDrillSize(PCB_VIA self, std::optional< int > const & aDrill)
        """
        return _pcbnew.PCB_VIA_SetTertiaryDrillSize(self, *args)

    def GetTertiaryDrillSize(self):
        r"""GetTertiaryDrillSize(PCB_VIA self) -> std::optional< int >"""
        return _pcbnew.PCB_VIA_GetTertiaryDrillSize(self)

    def SetTertiaryDrillStartLayer(self, aLayer):
        r"""SetTertiaryDrillStartLayer(PCB_VIA self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PCB_VIA_SetTertiaryDrillStartLayer(self, aLayer)

    def GetTertiaryDrillStartLayer(self):
        r"""GetTertiaryDrillStartLayer(PCB_VIA self) -> PCB_LAYER_ID"""
        return _pcbnew.PCB_VIA_GetTertiaryDrillStartLayer(self)

    def SetTertiaryDrillEndLayer(self, aLayer):
        r"""SetTertiaryDrillEndLayer(PCB_VIA self, PCB_LAYER_ID aLayer)"""
        return _pcbnew.PCB_VIA_SetTertiaryDrillEndLayer(self, aLayer)

    def GetTertiaryDrillEndLayer(self):
        r"""GetTertiaryDrillEndLayer(PCB_VIA self) -> PCB_LAYER_ID"""
        return _pcbnew.PCB_VIA_GetTertiaryDrillEndLayer(self)

    def SetTertiaryDrillShape(self, aShape):
        r"""SetTertiaryDrillShape(PCB_VIA self, PAD_DRILL_SHAPE aShape)"""
        return _pcbnew.PCB_VIA_SetTertiaryDrillShape(self, aShape)

    def GetTertiaryDrillShape(self):
        r"""GetTertiaryDrillShape(PCB_VIA self) -> PAD_DRILL_SHAPE"""
        return _pcbnew.PCB_VIA_GetTertiaryDrillShape(self)
...
class ZONE(BOARD_CONNECTED_ITEM):
    ...
    def InitDataFromSrcInCopyCtor(self, aZone, aLayer=UNDEFINED_LAYER):
        r"""InitDataFromSrcInCopyCtor(ZONE self, ZONE aZone, PCB_LAYER_ID aLayer=UNDEFINED_LAYER)"""
        return _pcbnew.ZONE_InitDataFromSrcInCopyCtor(self, aZone, aLayer)
    ...
    def GetFilledPolysList(self, aLayer):
        r"""GetFilledPolysList(ZONE self, PCB_LAYER_ID aLayer) -> std::shared_ptr< SHAPE_POLY_SET >"""
    ...
    def Clone(self, *args):
        ...
        """
        return _pcbnew.ZONE_Clone(self, *args)
    ...
    def GetPlacementAreaEnabled(self):
        r"""GetPlacementAreaEnabled(ZONE self) -> bool"""
        return _pcbnew.ZONE_GetPlacementAreaEnabled(self)

    def SetPlacementAreaEnabled(self, aEnabled):
        r"""SetPlacementAreaEnabled(ZONE self, bool aEnabled)"""
        return _pcbnew.ZONE_SetPlacementAreaEnabled(self, aEnabled)

    def GetPlacementAreaSource(self):
        r"""GetPlacementAreaSource(ZONE self) -> wxString"""
        return _pcbnew.ZONE_GetPlacementAreaSource(self)

    def SetPlacementAreaSource(self, aSource):
        r"""SetPlacementAreaSource(ZONE self, wxString aSource)"""
        return _pcbnew.ZONE_SetPlacementAreaSource(self, aSource)

    def GetPlacementAreaSourceType(self):
        r"""GetPlacementAreaSourceType(ZONE self) -> PLACEMENT_SOURCE_T"""
        return _pcbnew.ZONE_GetPlacementAreaSourceType(self)

    def SetPlacementAreaSourceType(self, aType):
        r"""SetPlacementAreaSourceType(ZONE self, PLACEMENT_SOURCE_T aType)"""
        return _pcbnew.ZONE_SetPlacementAreaSourceType(self, aType)
...
def InvokeCopperZonesEditor(aCaller, aZone, aSettings, aConvertSettings=None):
    r"""InvokeCopperZonesEditor(PCB_BASE_FRAME * aCaller, ZONE aZone, ZONE_SETTINGS aSettings, CONVERT_SETTINGS * aConvertSettings=None) -> int"""
    return _pcbnew.InvokeCopperZonesEditor(aCaller, aZone, aSettings, aConvertSettings)
...
PLACEMENT_SOURCE_T_SHEETNAME = _pcbnew.PLACEMENT_SOURCE_T_SHEETNAME

PLACEMENT_SOURCE_T_COMPONENT_CLASS = _pcbnew.PLACEMENT_SOURCE_T_COMPONENT_CLASS

PLACEMENT_SOURCE_T_GROUP_PLACEMENT = _pcbnew.PLACEMENT_SOURCE_T_GROUP_PLACEMENT

PLACEMENT_SOURCE_T_DESIGN_BLOCK = _pcbnew.PLACEMENT_SOURCE_T_DESIGN_BLOCK
...
class ZONE_SETTINGS(object):
    ...
    m_Netcode = property(_pcbnew.ZONE_SETTINGS_m_Netcode_get, _pcbnew.ZONE_SETTINGS_m_Netcode_set, doc=r"""m_Netcode : int""")
    ...
    def SetupLayersList(self, aList, aFrame, aLayers):
        r"""SetupLayersList(ZONE_SETTINGS self, wxDataViewListCtrl * aList, PCB_BASE_FRAME * aFrame, LSET aLayers)"""
        return _pcbnew.ZONE_SETTINGS_SetupLayersList(self, aList, aFrame, aLayers)
    ...
    def GetPlacementAreaEnabled(self):
        r"""GetPlacementAreaEnabled(ZONE_SETTINGS self) -> bool"""
        return _pcbnew.ZONE_SETTINGS_GetPlacementAreaEnabled(self)

    def GetPlacementAreaSourceType(self):
        r"""GetPlacementAreaSourceType(ZONE_SETTINGS self) -> PLACEMENT_SOURCE_T"""
        return _pcbnew.ZONE_SETTINGS_GetPlacementAreaSourceType(self)

    def GetPlacementAreaSource(self):
        r"""GetPlacementAreaSource(ZONE_SETTINGS self) -> wxString"""
        return _pcbnew.ZONE_SETTINGS_GetPlacementAreaSource(self)
    ...
    def SetPlacementAreaEnabled(self, aEnabled):
        r"""SetPlacementAreaEnabled(ZONE_SETTINGS self, bool aEnabled)"""
        return _pcbnew.ZONE_SETTINGS_SetPlacementAreaEnabled(self, aEnabled)

    def SetPlacementAreaSourceType(self, aType):
        r"""SetPlacementAreaSourceType(ZONE_SETTINGS self, PLACEMENT_SOURCE_T aType)"""
        return _pcbnew.ZONE_SETTINGS_SetPlacementAreaSourceType(self, aType)

    def SetPlacementAreaSource(self, aSource):
        r"""SetPlacementAreaSource(ZONE_SETTINGS self, wxString aSource)"""
        return _pcbnew.ZONE_SETTINGS_SetPlacementAreaSource(self, aSource)
...
class EDA_SHAPE_HATCH_CACHE_DATA(object):
    r"""Proxy of C++ EDA_SHAPE_HATCH_CACHE_DATA class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    hatching = property(_pcbnew.EDA_SHAPE_HATCH_CACHE_DATA_hatching_get, _pcbnew.EDA_SHAPE_HATCH_CACHE_DATA_hatching_set, doc=r"""hatching : SHAPE_POLY_SET""")
    hatchLines = property(_pcbnew.EDA_SHAPE_HATCH_CACHE_DATA_hatchLines_get, _pcbnew.EDA_SHAPE_HATCH_CACHE_DATA_hatchLines_set, doc=r"""hatchLines : std::vector<(SEG,std::allocator<(SEG)>)>""")

    def __init__(self):
        r"""__init__(EDA_SHAPE_HATCH_CACHE_DATA self) -> EDA_SHAPE_HATCH_CACHE_DATA"""
        _pcbnew.EDA_SHAPE_HATCH_CACHE_DATA_swiginit(self, _pcbnew.new_EDA_SHAPE_HATCH_CACHE_DATA())
    __swig_destroy__ = _pcbnew.delete_EDA_SHAPE_HATCH_CACHE_DATA

# Register EDA_SHAPE_HATCH_CACHE_DATA in _pcbnew:
_pcbnew.EDA_SHAPE_HATCH_CACHE_DATA_swigregister(EDA_SHAPE_HATCH_CACHE_DATA)
class EDA_SHAPE(object):
    ...
    def __init__(self, *args):
        ...
        __init__(EDA_SHAPE self, EDA_SHAPE aOther) -> EDA_SHAPE
        __init__(EDA_SHAPE self, EDA_SHAPE arg2) -> EDA_SHAPE
        """
    ...
    def GetHatchLines(self):
        r"""GetHatchLines(EDA_SHAPE self) -> std::vector< SEG,std::allocator< SEG > > const &"""
        return _pcbnew.EDA_SHAPE_GetHatchLines(self)
    ...
    def GetCornersInSequence(self, angle):
        r"""GetCornersInSequence(EDA_SHAPE self, EDA_ANGLE angle) -> VECTOR_VECTOR2I"""
        return _pcbnew.EDA_SHAPE_GetCornersInSequence(self, angle)
    ...
    def GetPolyPoints(self):
        r"""GetPolyPoints(EDA_SHAPE self) -> VECTOR_VECTOR2I"""
        return _pcbnew.EDA_SHAPE_GetPolyPoints(self)
    ...
    def MakeEffectiveShapesForHitTesting(self):
        r"""MakeEffectiveShapesForHitTesting(EDA_SHAPE self) -> std::vector< SHAPE *,std::allocator< SHAPE * > >"""
        return _pcbnew.EDA_SHAPE_MakeEffectiveShapesForHitTesting(self)
    ...
    def SetCornerRadius(self, aRadius):
        r"""SetCornerRadius(EDA_SHAPE self, int aRadius)"""
        return _pcbnew.EDA_SHAPE_SetCornerRadius(self, aRadius)

    def GetCornerRadius(self):
        r"""GetCornerRadius(EDA_SHAPE self) -> int"""
        return _pcbnew.EDA_SHAPE_GetCornerRadius(self)
    ...
    def UpdateHatching(self):
        r"""UpdateHatching(EDA_SHAPE self)"""
        return _pcbnew.EDA_SHAPE_UpdateHatching(self)
...
class PCB_SHAPE(BOARD_CONNECTED_ITEM, EDA_SHAPE):
    ...
    def TransformShapeToPolySet(self, aBuffer, aLayer, aClearance, aError, aErrorLoc, aRenderSettings=None):
        r"""TransformShapeToPolySet(PCB_SHAPE self, SHAPE_POLY_SET aBuffer, PCB_LAYER_ID aLayer, int aClearance, int aError, ERROR_LOC aErrorLoc, KIGFX::RENDER_SETTINGS * aRenderSettings=None)"""
        return _pcbnew.PCB_SHAPE_TransformShapeToPolySet(self, aBuffer, aLayer, aClearance, aError, aErrorLoc, aRenderSettings)
...
class PCB_TEXT(BOARD_ITEM, EDA_TEXT):
    ...
    def __init__(self, *args):
        ...
        __init__(PCB_TEXT self, PCB_TEXT aOther) -> PCB_TEXT
        __init__(PCB_TEXT self, PCB_TEXT arg2) -> PCB_TEXT
        """
    ...
    def GetKnockoutCache(self, aFont, forResolvedText, aMaxError):
        r"""GetKnockoutCache(PCB_TEXT self, KIFONT::FONT const * aFont, wxString forResolvedText, int aMaxError) -> SHAPE_POLY_SET"""
        return _pcbnew.PCB_TEXT_GetKnockoutCache(self, aFont, forResolvedText, aMaxError)
    ...
    @staticmethod
    def ShowSyntaxHelp(aParentWindow):
        r"""ShowSyntaxHelp(wxWindow * aParentWindow) -> HTML_MESSAGE_BOX *"""
        return _pcbnew.PCB_TEXT_ShowSyntaxHelp(aParentWindow)
...
class PCB_TEXTBOX(PCB_SHAPE, EDA_TEXT):
    ...
    def GetMinSize(self):
        r"""GetMinSize(PCB_TEXTBOX self) -> VECTOR2I"""
        return _pcbnew.PCB_TEXTBOX_GetMinSize(self)
    ...
    def GetClass(self):
        r"""GetClass(PCB_TEXTBOX self) -> wxString"""
        return _pcbnew.PCB_TEXTBOX_GetClass(self)
...
class TEXT_ATTRIBUTES(object):
    ...
    m_Hover = property(_pcbnew.TEXT_ATTRIBUTES_m_Hover_get, _pcbnew.TEXT_ATTRIBUTES_m_Hover_set, doc=r"""m_Hover : bool""")
...
class PCB_FIELD(PCB_TEXT):
    ...
    def GetClass(self):
        r"""GetClass(PCB_FIELD self) -> wxString"""
        return _pcbnew.PCB_FIELD_GetClass(self)
    ...
    def HasHypertext(self):
        r"""HasHypertext(PCB_FIELD self) -> bool"""
        return _pcbnew.PCB_FIELD_HasHypertext(self)
    ...
    def GetShownText(self, aAllowExtraText, aDepth=0):
        r"""GetShownText(PCB_FIELD self, bool aAllowExtraText, int aDepth=0) -> wxString"""
        return _pcbnew.PCB_FIELD_GetShownText(self, aAllowExtraText, aDepth)
...
class PCB_DIMENSION_BASE(PCB_TEXT):
    ...
    def GetEffectiveShape(self, *args):
        r"""GetEffectiveShape(PCB_DIMENSION_BASE self, PCB_LAYER_ID aLayer=UNDEFINED_LAYER, FLASHING aFlash=DEFAULT) -> std::shared_ptr< SHAPE >"""
...
class PCB_DIM_RADIAL(PCB_DIMENSION_BASE):
    ...
    def GetClass(self):
        r"""GetClass(PCB_DIM_RADIAL self) -> wxString"""
        return _pcbnew.PCB_DIM_RADIAL_GetClass(self)
...
class PCB_MARKER(BOARD_ITEM, MARKER_BASE):
    ...
    def GetShapes(self):
        r"""GetShapes(PCB_MARKER self) -> std::vector< PCB_SHAPE,std::allocator< PCB_SHAPE > >"""
        return _pcbnew.PCB_MARKER_GetShapes(self)

    def SetPath(self, aShapes, aStart, aEnd):
        r"""SetPath(PCB_MARKER self, std::vector< PCB_SHAPE,std::allocator< PCB_SHAPE > > const & aShapes, VECTOR2I aStart, VECTOR2I aEnd)"""
        return _pcbnew.PCB_MARKER_SetPath(self, aShapes, aStart, aEnd)
...
class PCB_TABLE(BOARD_ITEM_CONTAINER):
    ...
    def GetClass(self):
        r"""GetClass(PCB_TABLE self) -> wxString"""
        return _pcbnew.PCB_TABLE_GetClass(self)
    ...
    def Autosize(self):
        r"""Autosize(PCB_TABLE self)"""
        return _pcbnew.PCB_TABLE_Autosize(self)
    ...
    def TransformShapeToPolySet(self, aBuffer, aLayer, aClearance, aError, aErrorLoc, aRenderSettings=None):
        r"""TransformShapeToPolySet(PCB_TABLE self, SHAPE_POLY_SET aBuffer, PCB_LAYER_ID aLayer, int aClearance, int aError, ERROR_LOC aErrorLoc, KIGFX::RENDER_SETTINGS * aRenderSettings=None)"""
        return _pcbnew.PCB_TABLE_TransformShapeToPolySet(self, aBuffer, aLayer, aClearance, aError, aErrorLoc, aRenderSettings)

    def TransformGraphicItemsToPolySet(self, aBuffer, aMaxError, aErrorLoc, aRenderSettings):
        r"""TransformGraphicItemsToPolySet(PCB_TABLE self, SHAPE_POLY_SET aBuffer, int aMaxError, ERROR_LOC aErrorLoc, KIGFX::RENDER_SETTINGS * aRenderSettings)"""
        return _pcbnew.PCB_TABLE_TransformGraphicItemsToPolySet(self, aBuffer, aMaxError, aErrorLoc, aRenderSettings)
...
class NETCLASS(object):
    ...
    def HasTuningProfile(self):
        r"""HasTuningProfile(NETCLASS self) -> bool"""
        return _pcbnew.NETCLASS_HasTuningProfile(self)

    def SetTuningProfile(self, aTuningProfile):
        r"""SetTuningProfile(NETCLASS self, wxString aTuningProfile)"""
        return _pcbnew.NETCLASS_SetTuningProfile(self, aTuningProfile)

    def GetTuningProfile(self):
        r"""GetTuningProfile(NETCLASS self) -> wxString"""
        return _pcbnew.NETCLASS_GetTuningProfile(self)

    def SetTuningProfileParent(self, aParent):
        r"""SetTuningProfileParent(NETCLASS self, NETCLASS aParent)"""
        return _pcbnew.NETCLASS_SetTuningProfileParent(self, aParent)

    def GetTuningProfileParent(self):
        r"""GetTuningProfileParent(NETCLASS self) -> NETCLASS"""
        return _pcbnew.NETCLASS_GetTuningProfileParent(self)

# Register NETCLASS in _pcbnew:
_pcbnew.NETCLASS_swigregister(NETCLASS)
NETCLASS.Default = _pcbnew.cvar.NETCLASS_Default

class EDA_GROUP(object):
    r"""Proxy of C++ EDA_GROUP class."""
    ...
    def AsEdaItem(self):
        r"""AsEdaItem(EDA_GROUP self) -> EDA_ITEM"""
        return _pcbnew.EDA_GROUP_AsEdaItem(self)
    __swig_destroy__ = _pcbnew.delete_EDA_GROUP

    def GetName(self):
        r"""GetName(EDA_GROUP self) -> wxString"""
        return _pcbnew.EDA_GROUP_GetName(self)

    def SetName(self, aName):
        r"""SetName(EDA_GROUP self, wxString aName)"""
        return _pcbnew.EDA_GROUP_SetName(self, aName)
    ...
    def GetItems(self, *args):
        ...
        """
        return _pcbnew.EDA_GROUP_GetItems(self, *args)

    def AddItem(self, aItem):
        r"""AddItem(EDA_GROUP self, EDA_ITEM aItem)"""
        return _pcbnew.EDA_GROUP_AddItem(self, aItem)

    def RemoveItem(self, aItem):
        r"""RemoveItem(EDA_GROUP self, EDA_ITEM aItem)"""
        return _pcbnew.EDA_GROUP_RemoveItem(self, aItem)

    def RemoveAll(self):
        r"""RemoveAll(EDA_GROUP self)"""
        return _pcbnew.EDA_GROUP_RemoveAll(self)

    def GetGroupMemberIds(self):
        r"""GetGroupMemberIds(EDA_GROUP self) -> KIID_VECT_LIST"""
        return _pcbnew.EDA_GROUP_GetGroupMemberIds(self)

    def HasDesignBlockLink(self):
        r"""HasDesignBlockLink(EDA_GROUP self) -> bool"""
        return _pcbnew.EDA_GROUP_HasDesignBlockLink(self)

    def SetDesignBlockLibId(self, aLibId):
        r"""SetDesignBlockLibId(EDA_GROUP self, LIB_ID aLibId)"""
        return _pcbnew.EDA_GROUP_SetDesignBlockLibId(self, aLibId)

    def GetDesignBlockLibId(self):
        r"""GetDesignBlockLibId(EDA_GROUP self) -> LIB_ID"""
        return _pcbnew.EDA_GROUP_GetDesignBlockLibId(self)

# Register EDA_GROUP in _pcbnew:
_pcbnew.EDA_GROUP_swigregister(EDA_GROUP)
class PCB_GROUP(BOARD_ITEM, EDA_GROUP):
    ...
    def Serialize(self, aContainer):
        r"""Serialize(PCB_GROUP self, google::protobuf::Any & aContainer)"""
        return _pcbnew.PCB_GROUP_Serialize(self, aContainer)

    def Deserialize(self, aContainer):
        r"""Deserialize(PCB_GROUP self, google::protobuf::Any const & aContainer) -> bool"""
        return _pcbnew.PCB_GROUP_Deserialize(self, aContainer)
    ...
    def DeepDuplicate(self, addToParentGroup, aCommit=None):
        r"""DeepDuplicate(PCB_GROUP self, bool addToParentGroup, BOARD_COMMIT * aCommit=None) -> PCB_GROUP"""
        return _pcbnew.PCB_GROUP_DeepDuplicate(self, addToParentGroup, aCommit)
...
class PCB_REFERENCE_IMAGE(BOARD_ITEM):
    ...
    def GetClass(self):
        r"""GetClass(PCB_REFERENCE_IMAGE self) -> wxString"""
        return _pcbnew.PCB_REFERENCE_IMAGE_GetClass(self)
    ...
    def Serialize(self, aContainer):
        r"""Serialize(PCB_REFERENCE_IMAGE self, google::protobuf::Any & aContainer)"""
        return _pcbnew.PCB_REFERENCE_IMAGE_Serialize(self, aContainer)

    def Deserialize(self, aContainer):
        r"""Deserialize(PCB_REFERENCE_IMAGE self, google::protobuf::Any const & aContainer) -> bool"""
        return _pcbnew.PCB_REFERENCE_IMAGE_Deserialize(self, aContainer)
    ...
    def HitTest(self, *args):
        ...
        HitTest(PCB_REFERENCE_IMAGE self, SHAPE_LINE_CHAIN aPoly, bool aContained) -> bool
        """
...
class LAYERS_CHECKED(object):
    r"""Proxy of C++ LAYERS_CHECKED class."""
    ...
    def __init__(self, *args):
        ...
        """
        _pcbnew.LAYERS_CHECKED_swiginit(self, _pcbnew.new_LAYERS_CHECKED(*args))
    layers = property(_pcbnew.LAYERS_CHECKED_layers_get, _pcbnew.LAYERS_CHECKED_layers_set, doc=r"""layers : LSET""")
    has_error = property(_pcbnew.LAYERS_CHECKED_has_error_get, _pcbnew.LAYERS_CHECKED_has_error_set, doc=r"""has_error : bool""")
    __swig_destroy__ = _pcbnew.delete_LAYERS_CHECKED

# Register LAYERS_CHECKED in _pcbnew:
_pcbnew.LAYERS_CHECKED_swigregister(LAYERS_CHECKED)
...
class BOARD_LISTENER(object):
    ...
    def OnBoardItemsAdded(self, aBoard, aBoardItems):
        r"""OnBoardItemsAdded(BOARD_LISTENER self, BOARD aBoard, std::vector< BOARD_ITEM *,std::allocator< BOARD_ITEM * > > & aBoardItems)"""
        return _pcbnew.BOARD_LISTENER_OnBoardItemsAdded(self, aBoard, aBoardItems)
    ...
    def OnBoardItemsRemoved(self, aBoard, aBoardItems):
        r"""OnBoardItemsRemoved(BOARD_LISTENER self, BOARD aBoard, std::vector< BOARD_ITEM *,std::allocator< BOARD_ITEM * > > & aBoardItems)"""
        return _pcbnew.BOARD_LISTENER_OnBoardItemsRemoved(self, aBoard, aBoardItems)
    ...
    def OnBoardItemsChanged(self, aBoard, aBoardItems):
        r"""OnBoardItemsChanged(BOARD_LISTENER self, BOARD aBoard, std::vector< BOARD_ITEM *,std::allocator< BOARD_ITEM * > > & aBoardItems)"""
        return _pcbnew.BOARD_LISTENER_OnBoardItemsChanged(self, aBoard, aBoardItems)
...
class BOARD(BOARD_ITEM_CONTAINER):
    ...
    def BoardOutline(self, *args):
        r"""
        BoardOutline(BOARD self) -> PCB_BOARD_OUTLINE
        BoardOutline(BOARD self) -> PCB_BOARD_OUTLINE const *
        """
        return _pcbnew.BOARD_BoardOutline(self, *args)

    def UpdateBoardOutline(self):
        r"""UpdateBoardOutline(BOARD self)"""
        return _pcbnew.BOARD_UpdateBoardOutline(self)
    ...
    def Points(self):
        r"""Points(BOARD self) -> PCB_POINTS"""
        return _pcbnew.BOARD_Points(self)
    ...
    def GetCurrentVariant(self):
        r"""GetCurrentVariant(BOARD self) -> wxString"""
        return _pcbnew.BOARD_GetCurrentVariant(self)

    def SetCurrentVariant(self, aVariant):
        r"""SetCurrentVariant(BOARD self, wxString aVariant)"""
        return _pcbnew.BOARD_SetCurrentVariant(self, aVariant)

    def GetVariantNames(self):
        r"""GetVariantNames(BOARD self) -> std::vector< wxString,std::allocator< wxString > > const &"""
        return _pcbnew.BOARD_GetVariantNames(self)

    def SetVariantNames(self, aNames):
        r"""SetVariantNames(BOARD self, std::vector< wxString,std::allocator< wxString > > const & aNames)"""
        return _pcbnew.BOARD_SetVariantNames(self, aNames)

    def HasVariant(self, aVariantName):
        r"""HasVariant(BOARD self, wxString aVariantName) -> bool"""
        return _pcbnew.BOARD_HasVariant(self, aVariantName)

    def AddVariant(self, aVariantName):
        r"""AddVariant(BOARD self, wxString aVariantName)"""
        return _pcbnew.BOARD_AddVariant(self, aVariantName)

    def DeleteVariant(self, aVariantName):
        r"""DeleteVariant(BOARD self, wxString aVariantName)"""
        return _pcbnew.BOARD_DeleteVariant(self, aVariantName)

    def RenameVariant(self, aOldName, aNewName):
        r"""RenameVariant(BOARD self, wxString aOldName, wxString aNewName)"""
        return _pcbnew.BOARD_RenameVariant(self, aOldName, aNewName)

    def GetVariantDescription(self, aVariantName):
        r"""GetVariantDescription(BOARD self, wxString aVariantName) -> wxString"""
        return _pcbnew.BOARD_GetVariantDescription(self, aVariantName)

    def SetVariantDescription(self, aVariantName, aDescription):
        r"""SetVariantDescription(BOARD self, wxString aVariantName, wxString aDescription)"""
        return _pcbnew.BOARD_SetVariantDescription(self, aVariantName, aDescription)

    def GetVariantNamesForUI(self):
        r"""GetVariantNamesForUI(BOARD self) -> wxArrayString"""
        return _pcbnew.BOARD_GetVariantNamesForUI(self)
    ...
    def HasItemsOnLayer(self, aLayer):
        r"""HasItemsOnLayer(BOARD self, PCB_LAYER_ID aLayer) -> bool"""
        return _pcbnew.BOARD_HasItemsOnLayer(self, aLayer)

    def RemoveAllItemsOnLayer(self, aLayer):
        r"""RemoveAllItemsOnLayer(BOARD self, PCB_LAYER_ID aLayer) -> bool"""
        return _pcbnew.BOARD_RemoveAllItemsOnLayer(self, aLayer)
    ...
    def RunOnNestedEmbeddedFiles(self, aFunction):
        r"""RunOnNestedEmbeddedFiles(BOARD self, std::function< void (EMBEDDED_FILES *) > const & aFunction)"""
        return _pcbnew.BOARD_RunOnNestedEmbeddedFiles(self, aFunction)
    ...
    def ResolveItem(self, aID, aAllowNullptrReturn=False):
        r"""ResolveItem(BOARD self, KIID aID, bool aAllowNullptrReturn=False) -> BOARD_ITEM"""
        return _pcbnew.BOARD_ResolveItem(self, aID, aAllowNullptrReturn)
    ...
    def InvalidateClearanceCache(self, aUuid):
        r"""InvalidateClearanceCache(BOARD self, KIID aUuid)"""
        return _pcbnew.BOARD_InvalidateClearanceCache(self, aUuid)

    def InitializeClearanceCache(self):
        r"""InitializeClearanceCache(BOARD self)"""
        return _pcbnew.BOARD_InitializeClearanceCache(self)
    ...
    def GetBoardPolygonOutlines(self, aOutlines, aInferOutlineIfNecessary, aErrorHandler=None, aAllowUseArcsInPolygons=False, aIncludeNPTHAsOutlines=False):
        r"""GetBoardPolygonOutlines(BOARD self, SHAPE_POLY_SET aOutlines, bool aInferOutlineIfNecessary, OUTLINE_ERROR_HANDLER * aErrorHandler=None, bool aAllowUseArcsInPolygons=False, bool aIncludeNPTHAsOutlines=False) -> bool"""
        return _pcbnew.BOARD_GetBoardPolygonOutlines(self, aOutlines, aInferOutlineIfNecessary, aErrorHandler, aAllowUseArcsInPolygons, aIncludeNPTHAsOutlines)
    ...
    def ConvertBrdLayerToPolygonalContours(self, aLayer, aOutlines, aRenderSettings=None):
        r"""ConvertBrdLayerToPolygonalContours(BOARD self, PCB_LAYER_ID aLayer, SHAPE_POLY_SET aOutlines, KIGFX::RENDER_SETTINGS * aRenderSettings=None)"""
        return _pcbnew.BOARD_ConvertBrdLayerToPolygonalContours(self, aLayer, aOutlines, aRenderSettings)
    ...
    def IsFrontLayer(self, aLayer):
        r"""IsFrontLayer(BOARD self, PCB_LAYER_ID aLayer) -> bool"""
        return _pcbnew.BOARD_IsFrontLayer(self, aLayer)

    def IsBackLayer(self, aLayer):
        r"""IsBackLayer(BOARD self, PCB_LAYER_ID aLayer) -> bool"""
        return _pcbnew.BOARD_IsBackLayer(self, aLayer)
    ...
    def GetPadWithPressFitAttrCount(self):
        r"""GetPadWithPressFitAttrCount(BOARD self) -> int"""
        return _pcbnew.BOARD_GetPadWithPressFitAttrCount(self)

    def GetPadWithCastellatedAttrCount(self):
        r"""GetPadWithCastellatedAttrCount(BOARD self) -> int"""
        return _pcbnew.BOARD_GetPadWithCastellatedAttrCount(self)

    def ComputeBoundingBox(self, aBoardEdgesOnly=False, aPhysicalLayersOnly=False):
        r"""ComputeBoundingBox(BOARD self, bool aBoardEdgesOnly=False, bool aPhysicalLayersOnly=False) -> BOX2I"""
        return _pcbnew.BOARD_ComputeBoundingBox(self, aBoardEdgesOnly, aPhysicalLayersOnly)
    ...
    def SynchronizeTuningProfileProperties(self):
        r"""SynchronizeTuningProfileProperties(BOARD self)"""
        return _pcbnew.BOARD_SynchronizeTuningProfileProperties(self)
    ...
    def GetTrackLength(self, aTrack):
        r"""GetTrackLength(BOARD self, PCB_TRACK aTrack) -> std::tuple< int,double,double,double,double >"""
    ...
    def SetEmbeddedFilesDelegate(self, aDelegate):
        r"""SetEmbeddedFilesDelegate(BOARD self, EMBEDDED_FILES * aDelegate)"""
        return _pcbnew.BOARD_SetEmbeddedFilesDelegate(self, aDelegate)
    ...
    def GetLengthCalculation(self):
        r"""GetLengthCalculation(BOARD self) -> LENGTH_DELAY_CALCULATION *"""
    ...
    def SaveToHistory(self, aProjectPath, aFileData):
        r"""SaveToHistory(BOARD self, wxString aProjectPath, std::vector< HISTORY_FILE_DATA,std::allocator< HISTORY_FILE_DATA > > & aFileData)"""
        return _pcbnew.BOARD_SaveToHistory(self, aProjectPath, aFileData)

    def GetItemByIdCache(self):
        r"""GetItemByIdCache(BOARD self) -> std::unordered_map< KIID,BOARD_ITEM * > const &"""
        return _pcbnew.BOARD_GetItemByIdCache(self)

    def CacheItemById(self, aItem):
        r"""CacheItemById(BOARD self, BOARD_ITEM aItem)"""
        return _pcbnew.BOARD_CacheItemById(self, aItem)

    def UncacheItemById(self, aId):
        r"""UncacheItemById(BOARD self, KIID aId)"""
        return _pcbnew.BOARD_UncacheItemById(self, aId)
    ...
    m_ZonesByNameCache = property(_pcbnew.BOARD_m_ZonesByNameCache_get, _pcbnew.BOARD_m_ZonesByNameCache_set, doc=r"""m_ZonesByNameCache : std::unordered_map<(wxString,std::vector<(p.ZONE,std::allocator<(p.ZONE)>)>)>""")
    m_DeflatedZoneOutlineCache = property(_pcbnew.BOARD_m_DeflatedZoneOutlineCache_get, _pcbnew.BOARD_m_DeflatedZoneOutlineCache_set, doc=r"""m_DeflatedZoneOutlineCache : std::unordered_map<(p.q(const).ZONE,SHAPE_POLY_SET)>""")
...
FOOTPRINT_STACKUP_EXPAND_INNER_LAYERS = _pcbnew.FOOTPRINT_STACKUP_EXPAND_INNER_LAYERS

FOOTPRINT_STACKUP_CUSTOM_LAYERS = _pcbnew.FOOTPRINT_STACKUP_CUSTOM_LAYERS
...
class FOOTPRINT_COURTYARD_CACHE_DATA(object):
    r"""Proxy of C++ FOOTPRINT_COURTYARD_CACHE_DATA class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    front = property(_pcbnew.FOOTPRINT_COURTYARD_CACHE_DATA_front_get, _pcbnew.FOOTPRINT_COURTYARD_CACHE_DATA_front_set, doc=r"""front : SHAPE_POLY_SET""")
    back = property(_pcbnew.FOOTPRINT_COURTYARD_CACHE_DATA_back_get, _pcbnew.FOOTPRINT_COURTYARD_CACHE_DATA_back_set, doc=r"""back : SHAPE_POLY_SET""")
    front_hash = property(_pcbnew.FOOTPRINT_COURTYARD_CACHE_DATA_front_hash_get, _pcbnew.FOOTPRINT_COURTYARD_CACHE_DATA_front_hash_set, doc=r"""front_hash : HASH_128""")
    back_hash = property(_pcbnew.FOOTPRINT_COURTYARD_CACHE_DATA_back_hash_get, _pcbnew.FOOTPRINT_COURTYARD_CACHE_DATA_back_hash_set, doc=r"""back_hash : HASH_128""")

    def __init__(self):
        r"""__init__(FOOTPRINT_COURTYARD_CACHE_DATA self) -> FOOTPRINT_COURTYARD_CACHE_DATA"""
        _pcbnew.FOOTPRINT_COURTYARD_CACHE_DATA_swiginit(self, _pcbnew.new_FOOTPRINT_COURTYARD_CACHE_DATA())
    __swig_destroy__ = _pcbnew.delete_FOOTPRINT_COURTYARD_CACHE_DATA

# Register FOOTPRINT_COURTYARD_CACHE_DATA in _pcbnew:
_pcbnew.FOOTPRINT_COURTYARD_CACHE_DATA_swigregister(FOOTPRINT_COURTYARD_CACHE_DATA)
class FOOTPRINT_GEOMETRY_CACHE_DATA(object):
    r"""Proxy of C++ FOOTPRINT_GEOMETRY_CACHE_DATA class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    bounding_box = property(_pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_bounding_box_get, _pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_bounding_box_set, doc=r"""bounding_box : BOX2I""")
    bounding_box_timestamp = property(_pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_bounding_box_timestamp_get, _pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_bounding_box_timestamp_set, doc=r"""bounding_box_timestamp : int""")
    text_excluded_bbox = property(_pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_text_excluded_bbox_get, _pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_text_excluded_bbox_set, doc=r"""text_excluded_bbox : BOX2I""")
    text_excluded_bbox_timestamp = property(_pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_text_excluded_bbox_timestamp_get, _pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_text_excluded_bbox_timestamp_set, doc=r"""text_excluded_bbox_timestamp : int""")
    hull = property(_pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_hull_get, _pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_hull_set, doc=r"""hull : SHAPE_POLY_SET""")
    hull_timestamp = property(_pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_hull_timestamp_get, _pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_hull_timestamp_set, doc=r"""hull_timestamp : int""")

    def __init__(self):
        r"""__init__(FOOTPRINT_GEOMETRY_CACHE_DATA self) -> FOOTPRINT_GEOMETRY_CACHE_DATA"""
        _pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_swiginit(self, _pcbnew.new_FOOTPRINT_GEOMETRY_CACHE_DATA())
    __swig_destroy__ = _pcbnew.delete_FOOTPRINT_GEOMETRY_CACHE_DATA

# Register FOOTPRINT_GEOMETRY_CACHE_DATA in _pcbnew:
_pcbnew.FOOTPRINT_GEOMETRY_CACHE_DATA_swigregister(FOOTPRINT_GEOMETRY_CACHE_DATA)
class FOOTPRINT_VARIANT(object):
    r"""Proxy of C++ FOOTPRINT_VARIANT class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        r"""__init__(FOOTPRINT_VARIANT self, wxString aName=wxEmptyString) -> FOOTPRINT_VARIANT"""
        _pcbnew.FOOTPRINT_VARIANT_swiginit(self, _pcbnew.new_FOOTPRINT_VARIANT(*args))

    def GetName(self):
        r"""GetName(FOOTPRINT_VARIANT self) -> wxString"""
        return _pcbnew.FOOTPRINT_VARIANT_GetName(self)

    def SetName(self, aName):
        r"""SetName(FOOTPRINT_VARIANT self, wxString aName)"""
        return _pcbnew.FOOTPRINT_VARIANT_SetName(self, aName)

    def GetDNP(self):
        r"""GetDNP(FOOTPRINT_VARIANT self) -> bool"""
        return _pcbnew.FOOTPRINT_VARIANT_GetDNP(self)

    def SetDNP(self, aDNP):
        r"""SetDNP(FOOTPRINT_VARIANT self, bool aDNP)"""
        return _pcbnew.FOOTPRINT_VARIANT_SetDNP(self, aDNP)

    def GetExcludedFromBOM(self):
        r"""GetExcludedFromBOM(FOOTPRINT_VARIANT self) -> bool"""
        return _pcbnew.FOOTPRINT_VARIANT_GetExcludedFromBOM(self)

    def SetExcludedFromBOM(self, aExclude):
        r"""SetExcludedFromBOM(FOOTPRINT_VARIANT self, bool aExclude)"""
        return _pcbnew.FOOTPRINT_VARIANT_SetExcludedFromBOM(self, aExclude)

    def GetExcludedFromPosFiles(self):
        r"""GetExcludedFromPosFiles(FOOTPRINT_VARIANT self) -> bool"""
        return _pcbnew.FOOTPRINT_VARIANT_GetExcludedFromPosFiles(self)

    def SetExcludedFromPosFiles(self, aExclude):
        r"""SetExcludedFromPosFiles(FOOTPRINT_VARIANT self, bool aExclude)"""
        return _pcbnew.FOOTPRINT_VARIANT_SetExcludedFromPosFiles(self, aExclude)

    def GetFieldValue(self, aFieldName):
        r"""GetFieldValue(FOOTPRINT_VARIANT self, wxString aFieldName) -> wxString"""
        return _pcbnew.FOOTPRINT_VARIANT_GetFieldValue(self, aFieldName)

    def SetFieldValue(self, aFieldName, aValue):
        r"""SetFieldValue(FOOTPRINT_VARIANT self, wxString aFieldName, wxString aValue)"""
        return _pcbnew.FOOTPRINT_VARIANT_SetFieldValue(self, aFieldName, aValue)

    def HasFieldValue(self, aFieldName):
        r"""HasFieldValue(FOOTPRINT_VARIANT self, wxString aFieldName) -> bool"""
        return _pcbnew.FOOTPRINT_VARIANT_HasFieldValue(self, aFieldName)

    def GetFields(self):
        r"""GetFields(FOOTPRINT_VARIANT self) -> MAP_STRING_STRING"""
        return _pcbnew.FOOTPRINT_VARIANT_GetFields(self)

    def __eq__(self, aOther):
        r"""__eq__(FOOTPRINT_VARIANT self, FOOTPRINT_VARIANT aOther) -> bool"""
        return _pcbnew.FOOTPRINT_VARIANT___eq__(self, aOther)
    __swig_destroy__ = _pcbnew.delete_FOOTPRINT_VARIANT

# Register FOOTPRINT_VARIANT in _pcbnew:
_pcbnew.FOOTPRINT_VARIANT_swigregister(FOOTPRINT_VARIANT)
class FOOTPRINT(BOARD_ITEM_CONTAINER):
    ...
    def Points(self, *args):
        ...
        Points(FOOTPRINT self) -> PCB_POINTS
        """
        return _pcbnew.FOOTPRINT_Points(self, *args)
    ...
    def GetLIB_ID(self):
        r"""GetLIB_ID(FOOTPRINT self) -> LIB_ID"""
        return _pcbnew.FOOTPRINT_GetLIB_ID(self)

    def GetName(self):
        r"""GetName(FOOTPRINT self) -> wxString"""
        return _pcbnew.FOOTPRINT_GetName(self)

    def GetLibNickname(self):
        r"""GetLibNickname(FOOTPRINT self) -> wxString"""
        return _pcbnew.FOOTPRINT_GetLibNickname(self)

    def GetDesc(self):
        r"""GetDesc(FOOTPRINT self) -> wxString"""
        return _pcbnew.FOOTPRINT_GetDesc(self)

    def GetPinCount(self):
        r"""GetPinCount(FOOTPRINT self) -> int"""
        return _pcbnew.FOOTPRINT_GetPinCount(self)

    def GetSearchTerms(self):
        r"""GetSearchTerms(FOOTPRINT self) -> std::vector< SEARCH_TERM,std::allocator< SEARCH_TERM > > &"""
        return _pcbnew.FOOTPRINT_GetSearchTerms(self)
    ...
    def SetStackupMode(self, aMode):
        r"""SetStackupMode(FOOTPRINT self, FOOTPRINT_STACKUP aMode)"""
        return _pcbnew.FOOTPRINT_SetStackupMode(self, aMode)

    def GetStackupMode(self):
        r"""GetStackupMode(FOOTPRINT self) -> FOOTPRINT_STACKUP"""
        return _pcbnew.FOOTPRINT_GetStackupMode(self)

    def SetStackupLayers(self, aLayers):
        r"""SetStackupLayers(FOOTPRINT self, LSET aLayers)"""
        return _pcbnew.FOOTPRINT_SetStackupLayers(self, aLayers)

    def GetStackupLayers(self):
        r"""GetStackupLayers(FOOTPRINT self) -> LSET"""
        return _pcbnew.FOOTPRINT_GetStackupLayers(self)
    ...
    def SetAllowMissingCourtyard(self, aAllow):
        r"""SetAllowMissingCourtyard(FOOTPRINT self, bool aAllow)"""
        return _pcbnew.FOOTPRINT_SetAllowMissingCourtyard(self, aAllow)

    def AllowSolderMaskBridges(self):
        r"""AllowSolderMaskBridges(FOOTPRINT self) -> bool"""
        return _pcbnew.FOOTPRINT_AllowSolderMaskBridges(self)

    def SetAllowSolderMaskBridges(self, aAllow):
        r"""SetAllowSolderMaskBridges(FOOTPRINT self, bool aAllow)"""
        return _pcbnew.FOOTPRINT_SetAllowSolderMaskBridges(self, aAllow)
    ...
    def ApplyDefaultSettings(self, board, aStyleFields, aStyleText, aStyleShapes, aStyleDimensions, aStyleBarcodes):
        r"""ApplyDefaultSettings(FOOTPRINT self, BOARD board, bool aStyleFields, bool aStyleText, bool aStyleShapes, bool aStyleDimensions, bool aStyleBarcodes)"""
        return _pcbnew.FOOTPRINT_ApplyDefaultSettings(self, board, aStyleFields, aStyleText, aStyleShapes, aStyleDimensions, aStyleBarcodes)

    def SetUnitInfo(self, aUnits):
        r"""SetUnitInfo(FOOTPRINT self, std::vector< FOOTPRINT::FP_UNIT_INFO,std::allocator< FOOTPRINT::FP_UNIT_INFO > > const & aUnits)"""
        return _pcbnew.FOOTPRINT_SetUnitInfo(self, aUnits)

    def GetUnitInfo(self):
        r"""GetUnitInfo(FOOTPRINT self) -> std::vector< FOOTPRINT::FP_UNIT_INFO,std::allocator< FOOTPRINT::FP_UNIT_INFO > > const &"""
        return _pcbnew.FOOTPRINT_GetUnitInfo(self)
    ...
    def GetVariant(self, *args):
        r"""
        GetVariant(FOOTPRINT self, wxString aVariantName) -> FOOTPRINT_VARIANT
        GetVariant(FOOTPRINT self, wxString aVariantName) -> FOOTPRINT_VARIANT
        """
        return _pcbnew.FOOTPRINT_GetVariant(self, *args)

    def SetVariant(self, aVariant):
        r"""SetVariant(FOOTPRINT self, FOOTPRINT_VARIANT aVariant)"""
        return _pcbnew.FOOTPRINT_SetVariant(self, aVariant)

    def AddVariant(self, aVariantName):
        r"""AddVariant(FOOTPRINT self, wxString aVariantName) -> FOOTPRINT_VARIANT"""
        return _pcbnew.FOOTPRINT_AddVariant(self, aVariantName)

    def DeleteVariant(self, aVariantName):
        r"""DeleteVariant(FOOTPRINT self, wxString aVariantName)"""
        return _pcbnew.FOOTPRINT_DeleteVariant(self, aVariantName)

    def RenameVariant(self, aOldName, aNewName):
        r"""RenameVariant(FOOTPRINT self, wxString aOldName, wxString aNewName)"""
        return _pcbnew.FOOTPRINT_RenameVariant(self, aOldName, aNewName)

    def HasVariant(self, aVariantName):
        r"""HasVariant(FOOTPRINT self, wxString aVariantName) -> bool"""
        return _pcbnew.FOOTPRINT_HasVariant(self, aVariantName)

    def GetVariants(self):
        r"""GetVariants(FOOTPRINT self) -> CASE_INSENSITIVE_MAP< FOOTPRINT_VARIANT > const &"""
        return _pcbnew.FOOTPRINT_GetVariants(self)

    def GetDNPForVariant(self, aVariantName):
        r"""GetDNPForVariant(FOOTPRINT self, wxString aVariantName) -> bool"""
        return _pcbnew.FOOTPRINT_GetDNPForVariant(self, aVariantName)

    def GetExcludedFromBOMForVariant(self, aVariantName):
        r"""GetExcludedFromBOMForVariant(FOOTPRINT self, wxString aVariantName) -> bool"""
        return _pcbnew.FOOTPRINT_GetExcludedFromBOMForVariant(self, aVariantName)

    def GetExcludedFromPosFilesForVariant(self, aVariantName):
        r"""GetExcludedFromPosFilesForVariant(FOOTPRINT self, wxString aVariantName) -> bool"""
        return _pcbnew.FOOTPRINT_GetExcludedFromPosFilesForVariant(self, aVariantName)

    def GetFieldValueForVariant(self, aVariantName, aFieldName):
        r"""GetFieldValueForVariant(FOOTPRINT self, wxString aVariantName, wxString aFieldName) -> wxString"""
        return _pcbnew.FOOTPRINT_GetFieldValueForVariant(self, aVariantName, aFieldName)
    ...
    def Duplicate(self, addToParentGroup, aCommit=None):
        r"""Duplicate(FOOTPRINT self, bool addToParentGroup, BOARD_COMMIT * aCommit=None) -> BOARD_ITEM"""
        return _pcbnew.FOOTPRINT_Duplicate(self, addToParentGroup, aCommit)

    def DuplicateItem(self, addToParentGroup, aCommit, aItem, addToFootprint=False):
        r"""DuplicateItem(FOOTPRINT self, bool addToParentGroup, BOARD_COMMIT * aCommit, BOARD_ITEM aItem, bool addToFootprint=False) -> BOARD_ITEM"""
        return _pcbnew.FOOTPRINT_DuplicateItem(self, addToParentGroup, aCommit, aItem, addToFootprint)
    ...
    def FixUpPadsForBoard(self, aBoard):
        r"""FixUpPadsForBoard(FOOTPRINT self, BOARD aBoard)"""
        return _pcbnew.FOOTPRINT_FixUpPadsForBoard(self, aBoard)
...
class FP_UNIT_INFO(object):
    r"""Proxy of C++ FOOTPRINT::FP_UNIT_INFO class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    m_unitName = property(_pcbnew.FP_UNIT_INFO_m_unitName_get, _pcbnew.FP_UNIT_INFO_m_unitName_set, doc=r"""m_unitName : wxString""")
    m_pins = property(_pcbnew.FP_UNIT_INFO_m_pins_get, _pcbnew.FP_UNIT_INFO_m_pins_set, doc=r"""m_pins : std::vector<(wxString,std::allocator<(wxString)>)>""")

    def __init__(self):
        r"""__init__(FP_UNIT_INFO self) -> FP_UNIT_INFO"""
        _pcbnew.FP_UNIT_INFO_swiginit(self, _pcbnew.new_FP_UNIT_INFO())
    __swig_destroy__ = _pcbnew.delete_FP_UNIT_INFO

# Register FP_UNIT_INFO in _pcbnew:
_pcbnew.FP_UNIT_INFO_swigregister(FP_UNIT_INFO)
