...
3. **The Ghost Pointer**: Our abIDE plugin runs constantly in the background. It does not get notified that the C++ core destroyed the board. Our plugin still holds the pointer to the *old, deleted* memory address.
