...
এই স্ক্রিপ্টটি আপনার দেওয়া `design.json` ফাইলটিকে রিড করে KiCad-এর স্কিম্যাটিক (`.kicad_sch`) ফাইল তৈরি করে এবং প্রজেক্টের রুট ফাইলে থাকা `.kicad_pro` ফাইলে Netclasses (Track width, clearance) অ্যাড করে দেয়।

**বেসিক ব্যবহার:**
```bash
python json2sch.py <project_dir> <design_json_path>
```

**ফ্ল্যাগসমূহ (Options):**
- `-h, --help` : এই কমান্ডের সাহায্যে আপনি এই স্ক্রিপ্টটির সব অপশন দেখতে পারবেন।
- `-o, --out OUT` : আপনি যদি স্কিম্যাটিকটি অন্য কোনো নামে বা অন্য কোনো ফোল্ডারে সেভ করতে চান, তবে এটি ব্যবহার করতে পারেন। (ডিফল্ট: প্রজেক্ট ফোল্ডারে `project_name.kicad_sch` নামে সেভ হয়)।
- `--dry-run` : এটি দিলে স্ক্রিপ্টটি স্কিম্যাটিক সেভ করবে না, জাস্ট চেক করবে যে আপনার JSON ফাইলে কোনো ভুল আছে কি না (Validation test)।
- `--apply-netclasses` : এটি ব্যবহার করলে JSON ফাইলে থাকা আপনার track width, clearance ইত্যাদি রুলসগুলো KiCad-এর `.kicad_pro` ফাইলে সেভ হয়ে যাবে। *(এটি রান করার সময় অবশ্যই KiCad পুরোপুরি ক্লোজ রাখতে হবে, নাহলে KiCad মেইন উইন্ডো ফাইলটিকে ওভাররাইট করে ফেলবে!)*
